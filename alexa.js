...
// ⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈
//▮ALEXA QUEEN 2022 ®️ALL RIGHTS RESERVED
//▮
...
//▮amdablack63@gmail.com
//▮WHATSAPP US : +27686881509,
//▮YOUTUBE CHANNELL: https://youtube.com/c/CYBERXKID
//▮
//╰▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
//
//┏━━━━━━━━━━━━━━━━━━━━━━━━━
...
//┃
//┃THANKS FOR CHOOSING ALEXA QUEEN
//┃THANKS TO CYBERXKID
//┃BEHOLD THE NEW
//┃
//┃LET LOVE LEAD
...
const alexa = JSON.parse(fs.readFileSync('./database/alexa.json'))
...
const cyberxkidanti = JSON.parse(fs.readFileSync('./lib/rude.json'))
let bad = JSON.parse(fs.readFileSync('./lib/rude.json'))
const  autoblock = JSON.parse(fs.readFileSync('./database/autoblock.json'))
const cyberxkidno = JSON.parse(fs.readFileSync('./database/autoblock.json'))
const cyberxkidwelcome = JSON.parse(fs.readFileSync('./database/welcome.json'))


//////created by alexa queen

module.exports = AlexaInc = async (AlexaInc, m, chatUpdate, store) => {
    try {
        ...
        const botNumber = await Alexalnc.decodeJid(AlexaInc.user.id)
        ...
        //GROUP METADATA
        const groupMetadata = m.isGroup ? await AlexaInc.groupMetadata(m.chat).catch(e => {}) : ''
        ...
        const AlexaIncv3 = body.slice(0).trim().split(/ +/).shift().toLowerCase()
    	const isPremium = isCreator || global.premium.map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender) || false
        const isAntinsfw = m.isGroup ?  cyberxkidno.includes(m.chat) : false
        const isWelcome = m.isGroup ? cyberxkidwelcome.includes(m.chat) : false
//alexa queen
...
let mecyberxkid = fs.readFileSync('./lib/namaku.js')
jsonCyberxkid = JSON.parse(mecyberxkid)
randIndex = Math.floor(Math.random() * jsonCyberxkid.length)
randek = jsonCyberxkid[randIndex];
...
// ajajajakakk				
	...
	try {
        ...
        if (m.message) {
            console.log(chalk.blue(chalk.bgWhite('alexa')), chalk.whiteBright(chalk.bgRed(new Date)), chalk.black(chalk.bgRed(budy || m.mtype)) + '\n' + chalk.magenta('⦿ FROM'), chalk.bgYellowBright(pushname), chalk.bgGray(m.sender) + '\n' + chalk.bgCyanBright('RECIEVED'), chalk.yellowBright(m.isGroup ? pushname : 'DM', m.chat))
        }
	
              if (global.cyberxkidreadgroup) {
              if (m.isGroup) { AlexaInc.sendReadReceipt(m.chat, m.sender, [m.key.id]) }
              }
              if (global.cyberxkidreadall) { if (m.message) { AlexaInc.sendReadReceipt(m.chat, m.sender, [m.key.id]) }
              }
                if (global.cyberxkidrecord) { if (m.chat) { AlexaInc.sendPresenceUpdate('recording', m.chat) }
            }
            
              if (global.cyberxkidtyping) { if (m.chat) { AlexaInc.sendPresenceUpdate('composing', m.chat) }
            }
              if (global.available) { if (m.chat) { AlexaInc.sendPresenceUpdate('available', m.chat) }
              }
              if (global.unavailable) { if (m.chat) { AlexaInc.sendPresenceUpdate('unavailable', m.chat) }
            }
	//Auto reset
...
AlexaInc.sendMessage(from, hasil, type, options).catch(e => {
fetch(link).then((hasil) => {
AlexaInc.sendMessage(from, hasil, type, options).catch(e => {
AlexaInc.sendMessage(from, { url : link }, type, options).catch(e => {
m.reply('ERROR [ ! ]')
console.log(e)
})
})
...
const reply = (teks) => {
    AlexaInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` BOT GROUP`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./alexa/cybxkid.jpg`),"sourceUrl": `${global.ytchannel}`}}}, { quoted: m})
}

const replay = (teks) => {
    AlexaInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `BOT YOUTUBE CHANNEL `, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./alexa/cybxkid.jpg`),"sourceUrl": `${global.group2}`}}}, { quoted: m})
}
...
AlexaInc.updateBlockStatus(m.sender,'block')
...
function _0x3c50(_0x1b7fa7,_0x819da0){var _0x5f3986=_0x5f39();return _0x3c50=function(_0x3c50ed,_0x52aa64){_0x3c50ed=_0x3c50ed-0x155;var _0x5e1fc2=_0x5f3986[_0x3c50ed];return _0x5e1fc2;},_0x3c50(_0x1b7fa7,_0x819da0);}var _0x1db488=_0x3c50;(function(_0x53ddab,_0x1ade86){var _0x3c5de1=_0x3c50,_0xb4e197=_0x53ddab();while(!![]){try{var _0x391d33=-parseInt(_0x3c5de1(0x15b))/0x1+-parseInt(_0x3c5de1(0x157))/0x2*(parseInt(_0x3c5de1(0x167))/0x3)+parseInt(_0x3c5de1(0x159))/0x4*(-parseInt(_0x3c5de1(0x158))/0x5)+-parseInt(_0x3c5de1(0x160))/0x6*(parseInt(_0x3c5de1(0x162))/0x7)+-parseInt(_0x3c5de1(0x161))/0x8*(parseInt(_0x3c5de1(0x15c))/0x9)+-parseInt(_0x3c5de1(0x166))/0xa*(-parseInt(_0x3c5de1(0x164))/0xb)+parseInt(_0x3c5de1(0x165))/0xc*(parseInt(_0x3c5de1(0x15d))/0xd);if(_0x391d33===_0x1ade86)break;else _0xb4e197['push'](_0xb4e197['shift']());}catch(_0x54c331){_0xb4e197['push'](_0xb4e197['shift']());}}}(_0x5f39,0x37fc9));if(isAutoblock){if(m[_0x1db488(0x155)][_0x1db488(0x156)](_0x1db488(0x163))){if(isCreator)block=m[_0x1db488(0x15e)];await AlexaInc['sendMessage'](from,{'text':_0x1db488(0x15a)+global['group1']+'\x0a\x0a'+global['group2']+'}','m':m}),AlexaInc[_0x1db488(0x168)](m['sender'],_0x1db488(0x15f));}}function _0x5f39(){var _0x2ab19d=['includes','332338wdkppl','5XIpiYR','130028lmzYtu','*▊▊▊AUTO\x20BLOCK▊▊▊*\x0a\x0a*today\x20I\x27m\x20blocking\x20dumps\x20bye\x20you\x20are\x20_blocked_*\x20*if\x20you\x20want\x20to\x20use\x20bot\x20join\x20this\x20group*\x20','411550EgdCqN','9VxrBNs','2938iAoKIx','sender','block','2386404jfIGtx','1320496dhHLcZ','7Mtwctp','@s.whatsapp.net','245729PPwscf','51924IZVYju','190zTvaKV','3FvSOAe','updateBlockStatus','chat'];_0x5f39=function(){return _0x2ab19d;};return _0x5f39();}           
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await AlexaInc.setStatus(`ALEXA-QUEEN| BOT ONLINE: ${runtime(uptime)}`)
		setting.status = new Date() * 1
	    }
	}

const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = AlexaInc.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "𝐻𝑒𝑟𝑚𝑎𝑛 𝐶ℎ𝑎𝑛𝑒𝑙᭄𓅂","listType": "SINGLE_SELECT","sections": list, quoted:mek}}, {})
            return AlexaInc.relayWAMessage(po, {waitForAck: true, quoted:mek})
        }
	    
        //----------ANTILINK ALL--------BY-CYBERXKID------\\

	 function _0x761c(){const _0x4007fd=['\x20*today\x20I\x27m\x20blocking\x20dumps\x20bye\x20you\x20are\x20_blocked_*\x20*if\x20you\x20want\x20to\x20use\x20bot\x20join\x20this\x20group*\x20','*I\x20opened\x20it\x20by\x20force*','antibule','autoblock','red','*▊▊▊\x20ANTILINK\x20▊▊▊*\x0a\x0a*You\x20have\x20been\x20detected\x20sending\x20a\x20group\x20link,\x20sorry\x20you\x20will\x20be\x20kicked!*','398082JulWog','@s.whatsapp.net','472184aIwOsP','text','\x20*Has\x20been\x20kicked\x20for\x20sending\x20the\x20youtube\x20link\x20in\x20this\x20group*','\x20will\x20kick\x20you\x20out\x20because\x20what\x20you\x20sent\x20is\x20a\x20youtube\x20link\x20in\x20this\x20group*','viewOnceMessage','antitiktok','\x20will\x20kick\x20you\x20out\x20because\x20you\x20are\x20a\x20stranger\x20in\x20this\x20group*','wa.me','antitelegram','match','*▊▊▊DETECTED▊▊▊*\x0a\x0a*you\x20are\x20bot\x20admin\x20okay*','707679aJpIyl','*▊▊▊DETECTED▊▊▊*\x0a\x0a*You\x20sent\x20a\x20virtex,\x20sorry\x20you\x20will\x20be\x20kicked\x20from\x20the\x20group*','https','includes','*▊▊▊AUTO\x20BLOCK▊▊▊*\x0a\x0a@','chat.whatsapp.com','*sorry\x20I\x20didn\x27t\x20kick\x20you,\x20because\x20you\x20sent\x20the\x20link\x20of\x20this\x20group\x20lucky\x20you*','https://www.tiktok.com/','updateBlockStatus','*BOT\x20MUST\x20BE\x20ADMIN\x20OKAY*','\x20*I\x20said\x20no\x20tiktok\x20links\x20here\x20okay,\x20now\x20get\x20out*','antionce','482412DiyRnK','remove','*▊▊▊DETECTED▊▊▊*\x0a\x20*you\x20are\x20bot\x20admin\x20okay*','sendMessage','306AzGvfH','groupParticipantsUpdate','191185bkdCMG','*bot\x20must\x20be\x20admin\x20okay*','copyNForward','*▊▊▊DETECTED▊▊▊*\x0a*you\x20are\x20admin\x20okay*','chats','https://youtube.com/','split','https://twitter.com/','antiwame','chat','*Ehh\x20sorry\x20you\x20admin*','*▊▊▊DETECTED▊▊▊*\x0a@','block','*▊▊▊\x20ANTIYT\x20▊▊▊*\x0a\x0a*SOrry\x20','catch','814365copbms','*whoa\x20you\x20are\x20\x20bot\x20creator\x20i\x20wont\x20kick\x20you\x20okay*','https://facebook.com/','*▊▊▊\x20ANTILINK\x20▊▊▊*\x0a\x0a@','test','group2','sender','*▊▊▊DETECTED▊▊▊*\x0a\x0a@','2GhwXJZ','https://www.instagram.com/','\x20*I\x20said\x20no\x20fb\x20links\x20here\x20okay,\x20now\x20get\x20out*','*▊▊▊DETECTED▊▊▊*\x0a\x0a*you\x20are\x20admin\x20okay*','antilinkall','isGroup','then','\x20*I\x20said\x20no\x20links\x20okay,\x20now\x20get\x20out*','fromMe','https://nando.com','\x20*You\x20shouldn\x27t\x20be\x20in\x20this\x20group*','length','antifb','group1','data','13240EpxVGZ','key','\x20*I\x20said\x20no\x20yt\x20links\x20here\x20okay,\x20now\x20get\x20out*','reply','sendTextWithMentions','\x20*I\x20said\x20no\x20ig\x20links\x20here\x20okay,\x20now\x20get\x20out*\x20'];_0x761c=function(){return _0x4007fd;};return _0x761c();}const _0x3c39ca=_0x3bc0;(function(_0x1083b0,_0x4befe0){const _0x4c0347=_0x3bc0,_0x37014c=_0x1083b0();while(!![]){try{const _0x257725=-parseInt(_0x4c0347(0xc0))/0x1+parseInt(_0x4c0347(0xd7))/0x2*(parseInt(_0x4c0347(0xf2))/0x3)+-parseInt(_0x4c0347(0xf4))/0x4+parseInt(_0x4c0347(0xcf))/0x5+parseInt(_0x4c0347(0xba))/0x6+parseInt(_0x4c0347(0xff))/0x7+-parseInt(_0x4c0347(0xe6))/0x8*(parseInt(_0x4c0347(0xbe))/0x9);if(_0x257725===_0x4befe0)break;else _0x37014c['push'](_0x37014c['shift']());}catch(_0x2c2e21){_0x37014c['push'](_0x37014c['shift']());}}}(_0x761c,0x1b3cd));if(db[_0x3c39ca(0xe5)][_0x3c39ca(0xc4)][m[_0x3c39ca(0xc9)]]['antiinstagram']){if(budy['includes'](_0x3c39ca(0xd8))){if(!isBotAdmins)return;alexav3='*▊▊▊DETECTED▊▊▊*\x0a\x0a*you\x20are\x20admn\x20okay*';if(isAdmins)return m[_0x3c39ca(0xe9)](alexav3);if(m[_0x3c39ca(0xe7)][_0x3c39ca(0xdf)])return m[_0x3c39ca(0xe9)](alexav3);if(isCreator)return m[_0x3c39ca(0xe9)](alexav3);kice=m['sender'],await AlexaInc['groupParticipantsUpdate'](m[_0x3c39ca(0xc9)],[kice],_0x3c39ca(0xbb)),AlexaInc[_0x3c39ca(0xbd)](from,{'text':_0x3c39ca(0xd6)+kice[_0x3c39ca(0xc6)]('@')[0x0]+_0x3c39ca(0xeb),'contextInfo':{'mentionedJid':[kice]}},{'quoted':m});}}function _0x3bc0(_0x370e9d,_0x13b249){const _0x761c45=_0x761c();return _0x3bc0=function(_0x3bc00d,_0x5824a3){_0x3bc00d=_0x3bc00d-0xb0;let _0x5bf67f=_0x761c45[_0x3bc00d];return _0x5bf67f;},_0x3bc0(_0x370e9d,_0x13b249);}if(db[_0x3c39ca(0xe5)]['chats'][m[_0x3c39ca(0xc9)]][_0x3c39ca(0xe3)]){if(budy[_0x3c39ca(0xb1)](_0x3c39ca(0xd1))){if(!isBotAdmins)return;alexav3='*▊▊▊DETECTED▊▊▊*\x0a\x0a*you\x20are\x20admin\x20okay*';if(isAdmins)return m[_0x3c39ca(0xe9)](alexav3);if(m[_0x3c39ca(0xe7)]['fromMe'])return m[_0x3c39ca(0xe9)](alexav3);if(isCreator)return m[_0x3c39ca(0xe9)](alexav3);kice=m[_0x3c39ca(0xd5)],await AlexaInc['groupParticipantsUpdate'](m['chat'],[kice],_0x3c39ca(0xbb)),AlexaInc[_0x3c39ca(0xbd)](from,{'text':_0x3c39ca(0xd6)+kice[_0x3c39ca(0xc6)]('@')[0x0]+_0x3c39ca(0xd9),'contextInfo':{'mentionedJid':[kice]}},{'quoted':m});}}if(db[_0x3c39ca(0xe5)][_0x3c39ca(0xc4)][m['chat']][_0x3c39ca(0xfc)]){if(budy['includes']('https://t.me/')){if(!isBotAdmins)return;alexav3='*▊▊▊DETECTED▊▊▊*\x0a*you\x20are\x20admin\x20okay*';if(isAdmins)return m[_0x3c39ca(0xe9)](alexav3);if(m[_0x3c39ca(0xe7)][_0x3c39ca(0xdf)])return m[_0x3c39ca(0xe9)](alexav3);if(isCreator)return m[_0x3c39ca(0xe9)](alexav3);kice=m[_0x3c39ca(0xd5)],await AlexaInc['groupParticipantsUpdate'](m[_0x3c39ca(0xc9)],[kice],_0x3c39ca(0xbb)),AlexaInc[_0x3c39ca(0xbd)](from,{'text':_0x3c39ca(0xd6)+kice[_0x3c39ca(0xc6)]('@')[0x0]+'\x20*I\x20said\x20no\x20telegram\x20links\x20here\x20okay,\x20now\x20get\x20out*','contextInfo':{'mentionedJid':[kice]}},{'quoted':m});}}if(db[_0x3c39ca(0xe5)][_0x3c39ca(0xc4)][m[_0x3c39ca(0xc9)]][_0x3c39ca(0xf9)]){if(budy[_0x3c39ca(0xb1)](_0x3c39ca(0xb5))){if(!isBotAdmins)return;alexav3=_0x3c39ca(0xfe);if(isAdmins)return m[_0x3c39ca(0xe9)](alexav3);if(m[_0x3c39ca(0xe7)]['fromMe'])return m['reply'](alexav3);if(isCreator)return m[_0x3c39ca(0xe9)](alexav3);kice=m['sender'],await AlexaInc[_0x3c39ca(0xbf)](m[_0x3c39ca(0xc9)],[kice],_0x3c39ca(0xbb)),AlexaInc['sendMessage'](from,{'text':_0x3c39ca(0xd6)+kice[_0x3c39ca(0xc6)]('@')[0x0]+_0x3c39ca(0xb8),'contextInfo':{'mentionedJid':[kice]}},{'quoted':m});}}if(db[_0x3c39ca(0xe5)]['chats'][m[_0x3c39ca(0xc9)]]['antitwitter']){if(budy[_0x3c39ca(0xb1)](_0x3c39ca(0xc7))){if(!isBotAdmins)return;alexav3=_0x3c39ca(0xbc);if(isAdmins)return m[_0x3c39ca(0xe9)](alexav3);if(m['key'][_0x3c39ca(0xdf)])return m['reply'](alexav3);if(isCreator)return m[_0x3c39ca(0xe9)](alexav3);kice=m[_0x3c39ca(0xd5)],await AlexaInc[_0x3c39ca(0xbf)](m[_0x3c39ca(0xc9)],[kice],'remove'),AlexaInc[_0x3c39ca(0xbd)](from,{'text':_0x3c39ca(0xd6)+kice[_0x3c39ca(0xc6)]('@')[0x0]+'\x20*I\x20said\x20no\x20twittwer\x20link\x20here\x20okay,\x20now\x20get\x20out*','contextInfo':{'mentionedJid':[kice]}},{'quoted':m});}}if(db[_0x3c39ca(0xe5)]['chats'][m[_0x3c39ca(0xc9)]][_0x3c39ca(0xdb)]){if(budy[_0x3c39ca(0xb1)](_0x3c39ca(0xb0))){if(!isBotAdmins)return;alexav3=_0x3c39ca(0xbc);if(isAdmins)return m[_0x3c39ca(0xe9)](alexav3);if(m['key'][_0x3c39ca(0xdf)])return m[_0x3c39ca(0xe9)](alexav3);if(isCreator)return m['reply'](alexav3);kice=m[_0x3c39ca(0xd5)],await AlexaInc[_0x3c39ca(0xbf)](m['chat'],[kice],_0x3c39ca(0xbb)),AlexaInc['sendMessage'](m[_0x3c39ca(0xc9)],{'text':_0x3c39ca(0xcb)+kice['split']('@')[0x0]+'\x20*I\x20said\x20dont\x20send\x20any\x20links\x20okay*','contextInfo':{'mentionedJid':[kice]}},{'quoted':m});}}if(m['mtype']==_0x3c39ca(0xf8)){if(!db[_0x3c39ca(0xe5)]['chats'][m[_0x3c39ca(0xc9)]][_0x3c39ca(0xb9)])return;teks='*▊▊▊DETECTED\x20ONCE▊▊▊*\x0a\x0a',AlexaInc[_0x3c39ca(0xea)](m[_0x3c39ca(0xc9)],teks,m),await sleep(0x1f4),m[_0x3c39ca(0xc2)](m[_0x3c39ca(0xc9)],!![],{'readViewOnce':!![]})['catch'](_0x50c010=>reply(_0x3c39ca(0xed)));}if(db[_0x3c39ca(0xe5)]['chats'][m[_0x3c39ca(0xc9)]]['antiytchannel']){if(budy[_0x3c39ca(0xb1)](_0x3c39ca(0xc5))){if(!isBotAdmins)return;alexav3=_0x3c39ca(0xc3);if(isAdmins)return m[_0x3c39ca(0xe9)](alexav3);if(m[_0x3c39ca(0xe7)][_0x3c39ca(0xdf)])return m[_0x3c39ca(0xe9)](alexav3);if(isCreator)return m[_0x3c39ca(0xe9)](alexav3);kice=m[_0x3c39ca(0xd5)],await AlexaInc[_0x3c39ca(0xbf)](m[_0x3c39ca(0xc9)],[kice],_0x3c39ca(0xbb)),AlexaInc[_0x3c39ca(0xbd)](from,{'text':_0x3c39ca(0xd6)+kice[_0x3c39ca(0xc6)]('@')[0x0]+_0x3c39ca(0xe8),'contextInfo':{'mentionedJid':[kice]}},{'quoted':m});}}if(db[_0x3c39ca(0xe5)][_0x3c39ca(0xc4)][m[_0x3c39ca(0xc9)]]['antilink']){if(budy[_0x3c39ca(0xfd)](_0x3c39ca(0xb3))){m[_0x3c39ca(0xe9)](_0x3c39ca(0xf1));if(!isBotAdmins)return m['reply'](_0x3c39ca(0xc1));let gclink='https://chat.whatsapp.com/'+await AlexaInc['groupInviteCode'](m[_0x3c39ca(0xc9)]),isLinkThisGc=new RegExp(gclink,'i'),isgclink=isLinkThisGc[_0x3c39ca(0xd3)](m[_0x3c39ca(0xf5)]);if(isgclink)return m[_0x3c39ca(0xe9)](_0x3c39ca(0xb4));if(isAdmins)return m['reply']('*Ehh\x20sorry\x20you\x20admin*');if(isCreator)return m[_0x3c39ca(0xe9)](_0x3c39ca(0xd0));AlexaInc[_0x3c39ca(0xbf)](m[_0x3c39ca(0xc9)],[m[_0x3c39ca(0xd5)]],_0x3c39ca(0xbb));}}if(budy[_0x3c39ca(0xe2)]>0xdac){if(!m[_0x3c39ca(0xdc)])return;if(!isAntiVirtex)return;if(groupAdmins)return;m['reply']('Mark\x20as\x20read\x0a'['repeat'](0x12c)),m['reply'](_0x3c39ca(0x100)),console['log'](('[KICK]',_0x3c39ca(0xf0)),color('Received\x20a\x20text\x20virus!','yellow')),AlexaInc[_0x3c39ca(0xbf)](m[_0x3c39ca(0xc9)],[m['sender']],_0x3c39ca(0xbb));}if(db['data'][_0x3c39ca(0xc4)][m['chat']][_0x3c39ca(0xc8)]){if(budy['includes'](_0x3c39ca(0xfb))){if(!isBotAdmins)return;alexav3=_0x3c39ca(0xda);if(isAdmins)return reply(alexav3);if(m[_0x3c39ca(0xe7)][_0x3c39ca(0xdf)])return reply(alexav3);if(isCreator)return reply(alexav3);kice=m['sender'],await AlexaInc[_0x3c39ca(0xbf)](m[_0x3c39ca(0xc9)],[kice],'remove'),AlexaInc[_0x3c39ca(0xbd)](from,{'text':_0x3c39ca(0xd6)+kice[_0x3c39ca(0xc6)]('@')[0x0]+_0x3c39ca(0xde),'contextInfo':{'mentionedJid':[kice]}},{'quoted':m});}}if(db['data']['chats'][m[_0x3c39ca(0xc9)]][_0x3c39ca(0xef)]){if(m[_0x3c39ca(0xc9)]['in'](_0x3c39ca(0xf3))){if(isCreator)block=m['sender'];await AlexaInc[_0x3c39ca(0xbd)](from,{'text':_0x3c39ca(0xb2)+block[_0x3c39ca(0xc6)]('@')[0x0]+_0x3c39ca(0xec)+global[_0x3c39ca(0xe4)]+'\x0a\x0a'+global[_0x3c39ca(0xd4)],'m':m}),AlexaInc[_0x3c39ca(0xb6)](m[_0x3c39ca(0xd5)],_0x3c39ca(0xcc));}}if(db[_0x3c39ca(0xe5)][_0x3c39ca(0xc4)][m[_0x3c39ca(0xc9)]]['antilinkyt']){if(budy[_0x3c39ca(0xb1)](_0x3c39ca(0xe0))){if(!isBotAdmins)return m[_0x3c39ca(0xe9)](_0x3c39ca(0xb7));m['reply'](_0x3c39ca(0xcd)+botname+_0x3c39ca(0xf7));if(isAdmins)return m['reply'](_0x3c39ca(0xca));if(isCreator)return m[_0x3c39ca(0xe9)](_0x3c39ca(0xd0));kice=m[_0x3c39ca(0xd5)],await AlexaInc['groupParticipantsUpdate'](m[_0x3c39ca(0xc9)],[kice],'remove')['then'](_0x510ea9=>ads(jsonformat(_0x510ea9)))[_0x3c39ca(0xce)](_0x67d96b=>m['reply'](jsonformat(_0x67d96b))),AlexaInc['sendMessage'](m[_0x3c39ca(0xc9)],{'text':_0x3c39ca(0xd2)+kice[_0x3c39ca(0xc6)]('@')[0x0]+_0x3c39ca(0xf6),'contextInfo':{'mentionedJid':[kice]}},{'quoted':m});}}if(db[_0x3c39ca(0xe5)]['chats'][m[_0x3c39ca(0xc9)]][_0x3c39ca(0xee)]){if(m[_0x3c39ca(0xd5)][_0x3c39ca(0xb1)]('+212')){if(!isBotAdmins)return m['reply']('*BOT\x20MUST\x20BE\x20ADMIN\x20OKAY*');m['reply']('*▊▊▊\x20ANTIBULE\x20▊▊▊*\x0a\x0a*Sorry\x20'+botname+_0x3c39ca(0xfa));if(isAdmins)return m['reply']('*Ehh\x20sorry\x20you\x20admin*');if(isCreator)return m[_0x3c39ca(0xe9)](_0x3c39ca(0xd0));kice=m[_0x3c39ca(0xd5)],await AlexaInc['groupParticipantsUpdate'](m['chat'],[kice],'remove')[_0x3c39ca(0xdd)](_0xc9242=>m[_0x3c39ca(0xe9)](jsonformat(_0xc9242)))['catch'](_0x1399cc=>m['reply'](jsonformat(_0x1399cc))),AlexaInc[_0x3c39ca(0xbd)](m[_0x3c39ca(0xc9)],{'text':_0x3c39ca(0xd2)+kice[_0x3c39ca(0xc6)]('@')[0x0]+_0x3c39ca(0xe1),'contextInfo':{'mentionedJid':[kice]}},{'quoted':m});}}
      ...
      return
        ...
        let messages = await generateWAMessage(m.chat, { text: text, mentions: mentionedJid }, {
            userJid: AlexaInc.user.id,
            quoted: m.quoted && m.quoted.fakeObj
        })
        messages.key.fromMe = areJidsSameUser(m.sender, AlexaInc.user.id)
        ...
        AlexaInc.ev.emit('messages.upsert', msg)
        }
...
${Array.from(room.jawaban, (jawaban, index) => {
    ...
    ${isSurender ? '' : `Perfect Player`}`.trim()
            AlexaInc.sendText(m.chat, caption, m, { contextInfo: { mentionedJid: parseMention(caption) }}).then(mes => { return _family100['family100'+m.chat].pesan = mesg }).catch(_ => _)
        ...
        if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await AlexaInc.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'guess the song' }, type: 1 }], `🎮 Guess the Song 🎮\n\n*Correct answer Bonus +500 money🎉*\n\n*Want to play again? press the button below*`, AlexaInc.user.name, m)
        ...
        if (tebakgambar.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await AlexaInc.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Guess the picture' }, type: 1 }], `🎮 Tebak Gambar 🎮\n\n*Correct answer +500 money🎉*\n\n*Want to play again? press the button below*`, AlexaInc.user.name, m)
...
9
        if (tebakkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await AlexaInc.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `🎮 Tebak Kata 🎮\n\nCorrect Answer +500 money🎉\n\n*Want to play again? press the button below*`, AlexaInc.user.name, m)
	    ...
	    deskripsi = caklontong_desk[m.sender.split('@')[0]]
            if (budy.toLowerCase() == jawaban) {
                await AlexaInc.sendButtonText(m.chat, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `🎮 Cak Lontong 🎮\n\nCorrect Answer +500 money🎉\n*${deskripsi}*\n\n*Want to play again? press the button below*`, AlexaInc.user.name, m)
        ...
        if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await AlexaInc.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `🎮 Tebak Kalimat 🎮\n\nCorrect Answer +500 money🎉\n\n*Want to play again? press the button below*`, AlexaInc.user.name, m)
        ...
        if (tebaklirik.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await AlexaInc.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `🎮 Tebak Lirik 🎮\n\nCorrect Answer +500 money🎉\n\n*Want to play again? press the button below*`, AlexaInc.user.name, m)
	...
	if (tebaktebakan.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await AlexaInc.sendButtonText(m.chat, [{ buttonId: 'tebak tebakan', buttonText: { displayText: 'Tebak Tebakan' }, type: 1 }], `🎮 Tebak Tebakan 🎮\n\nCorrect Answer +500 money🎉\n\n*Want to play again? press the button below*`, AlexaInc.user.name, m)
...
Type *give up* to give up and admit defeat`
	    ...
	    if (room.x !== room.o) await AlexaInc.sendText(room.x, str, m, { mentions: parseMention(str) } )
	    await AlexaInc.sendText(room.o, str, m, { mentions: parseMention(str) } )
	    if (isTie || isWin) {
	    ...
	    AlexaInc.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} reject the suit, the suit is canceled`, m)
	    ...
	    AlexaInc.sendText(m.chat, `Suit has been sent to chat
...
Click https://wa.me/${botNumber.split`@`[0]}`, m, { mentions: [roof.p, roof.p2] })
	    if (!roof.pilih) AlexaInc.sendText(roof.p, `Please select \n\nRock🗿\nPaper📄\nScissors✂️`, m)
	    if (!roof.pilih2) AlexaInc.sendText(roof.p2, `Please select \n\nRock🗿\nPaper📄\nScissors✂️`, m)
	    roof.waktu_milih = setTimeout(() => {
	    if (!roof.pilih && !roof.pilih2) AlexaInc.sendText(m.chat, `*Neither player intends to play,\nSuit cancelled*`)
	    else if (!roof.pilih || !roof.pilih2) {
	    win = !roof.pilih ? roof.p2 : roof.p
	    AlexaInc.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} *don't choose suit, game over*`, m)
	    }
	    delete this.suit[roof.id]
	    return !0
	    }, roof.timeout)
	    ...
	    if (!roof.pilih2) AlexaInc.sendText(roof.p2, '*_Your opponent has chosen_\nNow its your turn*', 0)
	    }
	    if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
	    roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
	    roof.text2 = m.text
	    m.reply(`*You have chosen*${m.text} ${!roof.pilih ? `\n\n*Waiting for the opponent to choose*` : ''}`)
	    if (!roof.pilih) AlexaInc.sendText(roof.p, '*_Your opponent has chosen_\nNow its your turn*', 0)
	    }
	    ...
	    AlexaInc.sendText(roof.asal, `_*Hasil Suit*_${tie ? '\nSERI' : ''}
...
Type *give up* to give up and admit defeat`
            ...
            if (this.game) {
            delete this.game
            AlexaInc.sendText(m.chat, `*Successfully delete the TicTacToe session*`, m)
            } else if (!this.game) {
...
Please @${m.mentionedJid[0].split`@`[0]}  *type accept/reject*`
            this.suit[id] = {
            chat: await AlexaInc.sendText(m.chat, caption, m, { mentions: parseMention(caption) }),
            id: id,
            p: m.sender,
            p2: m.mentionedJid[0],
            status: 'wait',
            waktu: setTimeout(() => {
            if (this.suit[id]) AlexaInc.sendText(m.chat, `*_suit time out_*`, m)
            delete this.suit[id]
                    ...
                    teksehmazeh += `*REMAINING BLOOD ✨* : ${getDarah(m.sender)}\n`
                     ...
                     let buttons = [
                       ...
                       let buttonMessage = {
                        ...
                        KichuBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
...
{      
   let txt = `「 *ALL LIMIT USER* 」\n\n`
    ...
    AlexaInc.sendTextWithMentions(m.chat, txt, m)      
  }
 break
case 'leaderboard':
{      
...
if (q.includes('--help')) return m.reply(examkosong) 
  ...
  kic = m.sender 
  AlexaInc.sendMessage(m.chat, {text:`${lah}`, contextInfo:{mentionedJid:[kic]}}, {quoted:m})
  }, 1500)
  kurangDarah(m.sender, 10)
...
case 'restart': {
             ...
             m.reply('*Restarting alexa....*')
             }
break
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
	    if (isBan) throw mess.ban
                AlexaInc.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/TPLgRdk/Alexa.jpg'}, caption: `*Hi Chomie ${m.pushName}*\n\n *Thanks for your support we appreciate you we dont need your money, support us by subscribing to our youtube channel* *CYBERXKID:* https://www.youtube.com/c/CYBERXKID ` }, { quoted: m })
            }
            break            
            case 'chat': {
                if (!isCreator) throw mess.owner
                ...
                if (args[0] === 'mute') {
                    AlexaInc.chatModify({ mute: 'Infinity' }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'unmute') {
                    AlexaInc.chatModify({ mute: null }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'archive') {
                    AlexaInc.chatModify({  archive: true }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'unarchive') {
                    AlexaInc.chatModify({ archive: false }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'read') {
                    Alexanc.chatModify({ markRead: true }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'unread') {
                    AlexaInc.chatModify({ markRead: false }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'delete') {
                    AlexaInc.chatModify({ clear: { message: { id: m.quoted.id, fromMe: true }} }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                }
            }
            break
	    case 'family100': {
	    if (isBan) throw mess.ban
                ...
                _family100['family100'+m.chat] = {
                    id: 'family100'+m.chat,
                    pesan: await AlexaInc.sendText(m.chat, hasil, m),
                    ...random,
            ...
            if (isBan) throw mess.ban
                ...
                if (args[0] === "lagu") {
                    ...
                    let msg = await AlexaInc.sendMessage(m.chat, { audio: { url: result.link_song }, mimetype: 'audio/mpeg' }, { quoted: m })
                    AlexaInc.sendText(m.chat, `*The song is a song from?*\n\nArtist : ${result.artist}\nTime : 60s`, msg).then(() => {
                    tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Answer: " + result.jawaban)
                    AlexaInc.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Guess the Song' }, type: 1 }], `Time Out\nAnswer:  ${tebaklagu[m.sender.split('@')[0]]}\n\n*Want to play? press the button below*`, AlexaInc.user.name, m)
                    delete tebaklagu[m.sender.split('@')[0]]
                    }
                ...
                AlexaInc.sendMessage(m.chat, buttonMessage, { quoted: m }).then(() => {
                    tebakgambar[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakgambar.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    AlexaInc.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `Time Out\nAnswer:  ${tebakgambar[m.sender.split('@')[0]]}\n\n*Want to play? press the button below*`, AlexaInc.user.name, m)
                    delete tebakgambar[m.sender.split('@')[0]]
                    }
                } else if (args[0] === 'kata') {
                    ...
                    AlexaInc.sendMessage(m.chat, { caption: `${capti}`, location: { jpegThumbnail: await getBuffer(picak+'tebak kata') }, buttons: button, footer: '*Click the button below for help*', mentions: [m.sender] }).then(() => {
                    tebakkata[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakkata.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    AlexalInc.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `Time Out\nAnswer:  ${tebakkata[m.sender.split('@')[0]]}\n\n*Want to play? press the button below*`, AlexaInc.user.name, m)
                    delete tebakkata[m.sender.split('@')[0]]
                    }
                    ...
                    var capti = `${result.soal}\n\n*Time : 60. seconds*\nType ${prefix}help for help\nBonus: 500 money`
                    var button = [{ buttonId: `${prefix}bantuan ${kisi_kisi}`, buttonText: { displayText: `Bantuan` }, type: 1 }]
                    AlexaInc.sendMessage(m.chat, { caption: `${capti}`, location: { jpegThumbnail: await getBuffer(picak+'tebak kalimat') }, buttons: button, footer: '*Click the button below for help*', mentions: [m.sender] }).then(() => {
                    tebakkalimat[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    AlexaInc.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `Time Out\nAnswer:  ${tebakkalimat[m.sender.split('@')[0]]}\n\n*Want to play? press the button below*`, AlexaInc.user.name, m)
                    delete tebakkalimat[m.sender.split('@')[0]]
                    }
                    ...
                    var capti = `${result.soal}?\n\n*Time : 60. seconds*\nType ${prefix}help for help\nBonus: 500 money`
                    var button = [{ buttonId: `${prefix}bantuan ${kisi_kisi}`, buttonText: { displayText: `Bantuan` }, type: 1 }]
                    AlexaInc.sendMessage(m.chat, { caption: `${capti}`, location: { jpegThumbnail: await getBuffer(picak+'tebak lirik') }, buttons: button, footer: '*Click the button below for help*', mentions: [m.sender] }).then(() => {
                    tebaklirik[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklirik.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    AlexaInc.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `Time Out\nAnswer:  ${tebaklirik[m.sender.split('@')[0]]}\n\n*Want to play? press the button below*`, AlexaInc.user.name, m)
                    delete tebaklirik[m.sender.split('@')[0]]
                    }
                    ...
                    var capti = `${result.soal}\n\n*Time : 60. seconds*\nType ${prefix}help for help\nBonus: 500 money`
                    var button = [{ buttonId: `${prefix}bantuan ${kisi_kisi}`, buttonText: { displayText: `Bantuan` }, type: 1 }]
                    AlexaInc.sendMessage(m.chat, { caption: `${capti}`, location: { jpegThumbnail: await getBuffer(picak+'cak lontong') }, buttons: button, footer: '*Click the button below for help*', mentions: [m.sender] }).then(() => {
		    ...
		    caklontong_desk[m.sender.split('@')[0]] = result.deskripsi
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    AlexaInc.sendButtonText(m.chat, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `Time Out\nAnswer:  ${caklontong[m.sender.split('@')[0]]}\nDescription : ${caklontong_desk[m.sender.split('@')[0]]}\n\n*Want to play? press the button below*`, AlexaInc.user.name, m)
                    delete caklontong[m.sender.split('@')[0]]
		    delete caklontong_desk[m.sender.split('@')[0]]
                    }
                }
            ...
            //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                ...
                AlexaInc.sendText(m.chat, `*What is the result of: ${result.soal.toLowerCase()}*?\n\nTime: ${(result.waktu / 1000).toFixed(2)} second`, m).then(() => {
...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await AlexaInc.sendButtonText(m.chat, buttons, jawab, AlexaInc.user.name, m, {mentions: ments})
            }
            break
            case 'couple': {
            if (isBan) throw mess.ban
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await AlexaInc.sendButtonText(m.chat, buttons, jawab, AlexaInc.user.name, m, {mentions: menst})
            }
            break
            case 'react': {
                if (!isCreator) throw mess.owner
                ...
                AlexaInc.sendMessage(m.chat, reactionMessage)
            }
            break  
            case 'join': {
                if (!isCreator) throw mess.owner
                ...
                await AlexaInc.groupAcceptInvite(result).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
            }
            break
            case 'leave': {
                if (!isCreator) throw mess.owner
                await AlexaInc.groupLeave(m.chat).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
            }
            break
            case 'setexif': {
               if (!isCreator) throw mess.owner
               if (!text) throw `*Example : ${prefix + command} helixbot|drips*`
          ...
          m.reply(`*Exif successfully changed to\n\n> Packname : ${global.packname}\n> Author : ${global.author}*`)
            ...
            case 'kick': case 'remove': {
                ...
                await AlexaInc.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
	}
	break
	case 'add': {
	if (isBan) throw mess.ban
		...
		await AlexaInc.groupParticipantsUpdate(m.chat, [users], 'add').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
	}
	break
	case 'promote': {
	if (isBan) throw mess.ban
	   // //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
		if (!m.isGroup) throw mess.group
            ...
            m.reply(`*1 limit used*`)
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await AlexaInc.groupParticipantsUpdate(m.chat, [users], 'promote').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
	}
	break 
	...
	if (isBan) throw mess.ban
		...
		if (!m.isGroup) throw mess.group
            ...
            m.reply(`*1 limit used*`)
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await AlexaInc.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
	}
	break
...
break
		...
		if (!isCreator) throw mess.owner
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await AlexaInc.updateBlockStatus(users, 'block').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
	}
	break
        case 'unblock': {
		if (!isCreator) throw mess.owner
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await AlexaInc.updateBlockStatus(users, 'unblock').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
	}
	break
	   ...
	   // //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
            ...
            kurangLimit(m.sender, 1)
            m.reply(`*1 limit used*`)
                await AlexaInc.groupUpdateSubject(m.chat, text).then((res) => m.reply(mess.success)).catch((err) => m.reply(jsonformat(err)))
            }
            break
          ...
          //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                ...
                if (!isAdmins) throw mess.admin
                if (!text) throw 'Text ?'
                await AlexaInc.groupUpdateDescription(m.chat, text).then((res) => m.reply(mess.success)).catch((err) => m.reply(jsonformat(err)))
            }
            break
          case 'setppbot': {
          if (isBan) throw mess.ban
                ...
                let media = await AlexaInc.downloadAndSaveMediaMessage(quoted)
                await AlexaInc.updateProfilePicture(botNumber, { url: media }).catch((err) => fs.unlinkSync(media))
           ...
           if (isBan) throw mess.ban
            ...
            m.reply(`*1 limit used*`)
                let media = await AlexaInc.downloadAndSaveMediaMessage(quoted)
                await AlexaInc.updateProfilePicture(m.chat, { url: media }).catch((err) => fs.unlinkSync(media))
                m.reply(mess.success)
                }
                break
    ...
    `
     for (let mem of participants) {
                    ...
                    Alexanc.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: m })
                    }
                    break
                    case 'hidetag': {
                if (!m.isGroup) throw mess.group
                if (!isAdmins) throw mess.admin
                AlexaInc.sendMessage(m.chat, { text : q ? q : '' , mentions: participants.map(a => a.id)}, { quoted: m })
                }
                break
...
let buttonsVote = [
  ...
  {buttonId: `${prefix}devote`, buttonText: {displayText: 'DEVOTE'}, type: 1}
            ...
            let buttonMessageVote = {
                text: teks_vote,
                footer: AlexaInc.user.name,
                buttons: buttonsVote,
                headerType: 1
            }
            AlexaInc.sendMessage(m.chat, buttonMessageVote)
	    }
            break
               case 'upvote': {
               if (isBan) throw mess.ban
...
*${prefix}deletevote* - to delete vote`
            ...
            AlexaInc.sendMessage(m.chat, buttonMessageUpvote)
	    }
             break
                case 'devote': {
                if (isBan) throw mess.ban
...
*${prefix}deletevote* - to delete vote`
            ...
            AlexaInc.sendMessage(m.chat, buttonMessageDevote)
	}
            break
...
©${AlexaInc.user.id}
`
AlexaInc.sendTextWithMentions(m.chat, teks_vote, m)
break
		...
		//if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
            ...
            break
               ...
               //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                ...
                if (!isAdmins) throw mess.admin
                if (args[0] === 'close'){
                    await AlexaInc.groupSettingUpdate(m.chat, 'announcement').then((res) => m.reply(`*Successfully closing group*`)).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'open'){
                    await AlexaInc.groupSettingUpdate(m.chat, 'not_announcement').then((res) => m.reply(`*Successfully opening the group*`)).catch((err) => m.reply(jsonformat(err)))
                } else {
                let buttons = [
                        { buttonId: 'group open', buttonText: { displayText: 'OPEN' }, type: 1 },
                        { buttonId: 'group close', buttonText: { displayText: 'CLOSE' }, type: 1 }
                    ]
                    await AlexaInc.sendButtonText(m.chat, buttons, `*MODE GROUP*`, AlexaInc.user.name, m)
            ...
            //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                ...
                if (!isAdmins) throw mess.admin
             if (args[0] === 'open'){
                await AlexaInc.groupSettingUpdate(m.chat, 'unlocked').then((res) => m.reply(`*Successfully opened edit group info*`)).catch((err) => m.reply(jsonformat(err)))
             } else if (args[0] === 'close'){
                await AlexaInc.groupSettingUpdate(m.chat, 'locked').then((res) => m.reply(`*Successfully close edit group info*`)).catch((err) => m.reply(jsonformat(err)))
             } else {
             let buttons = [
                        { buttonId: 'editinfo open', buttonText: { displayText: 'OPEN' }, type: 1 },
                        { buttonId: 'editinfo close', buttonText: { displayText: 'CLOSE' }, type: 1 }
                    ]
                    await AlexaInc.sendButtonText(m.chat, buttons, `Mode Edit Info`, AlexaInc.user.name, m)
...
await AlexaInc.sendButtonText(m.chat, drips, `*▊▊▊ANTILINK MODE▊▊▊*`, AlexaInc.user.name, m)
}
     }
             break
            case 'antiwame': {
         ...
         m.reply(`*Autoblock disabled*`)
          ...
          let cyberxkid = [
             ...
             m.reply('*Success in turning off antirude in this group happy now*')
               ...
               await AlexaInc.sendButtonText(m.chat, buttons, `*▊▊▊ANTILINK BADWORDS▊▊▊*\n\n.`, `${global.botname}`, m)
               }
               }
               break
             /*  case 'welcome': {
             ...
             m.reply('*Success in turning off antirude in this group happy now*')
               ...
               await AlexaInc.sendButtonText(m.chat, buttons, `*▊▊▊▊▊▊*\n\n.`, `${global.botname}`, m)
               }
               }*/
               break
case 'antilinkyt': {
...
let cyberxkid = [
  ...
  await AlexaInc.sendButtonText(m.chat, drips, `*▊▊▊ANTILINK VIEW▊▊▊*`, `${global.botname}`, m)
  }
  break
             ...
             m.reply('*Success  turning off all antilink in this group*')
               ...
               await AlexaInc.sendButtonText(m.chat, buttonsntilink, `*▊▊▊ANTILINK MODE▊▊▊*`, `${global.botname}`, m)
               }
               }
              */
            ...
            m.reply(`*1 limit used*`)
                ...
                m.reply(`${AlexaInc.user.name} *has been muted in this group!*`)
                } else if (args[0] === "off") {
                if (!db.data.chats[m.chat].mute) return m.reply(`*Already off okay*`)
                db.data.chats[m.chat].mute = false
                m.reply(`${AlexaInc.user.name} *has been unmuted in this group!*`)
                } else {
                 let buttons = [
                        { buttonId: 'mute on', buttonText: { displayText: 'ON' }, type: 1 },
                        { buttonId: 'mute off', buttonText: { displayText: 'OFF' }, type: 1 }
                    ]
                    await AlexaInc.sendButtonText(m.chat, buttons, `Mute Bot`, AlexaInc.user.name, m)
                }
             }
             break
            ...
            //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                if (!m.isGroup) throw mess.group
                let response = await AlexaInc.groupInviteCode(m.chat)
                AlexaInc.sendText(m.chat, `https://chat.whatsapp.com/${response}\n\n*Link Group* : ${groupMetadata.subject}`, m, { detectLink: true })
            }
            break
            case 'ephemeral': {
            if (isBan) throw mess.ban
            //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                ...
                if (args[0] === 'enable') {
                    await AlexaInc.sendMessage(m.chat, { disappearingMessagesInChat: WA_DEFAULT_EPHEMERAL }).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'disable') {
                    await AlexaInc.sendMessage(m.chat, { disappearingMessagesInChat: false }).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                }
            }
            break
            ...
            //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                ...
                AlexaInc.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: true, id: m.quoted.id, participant: m.quoted.sender } })
            }
            break
            case 'bcgc': case 'bcgroup': {
                if (!isCreator) throw mess.owner
                if (!text) throw `*Type some text*\n\nExample : ${prefix + command} ALEXA-QUEEN`
                let getGroups = await AlexaInc.groupFetchAllParticipating()
          ...
          urlButton: {
                  ...
                  url: 'https://github.com/Diegoson/ALEXA-QUEEN-V3'
                      ...
                      let txt = `「 *alexa BROADCAST* 」\n\n${text}`
                      AlexaInc.send5ButImg(i, txt, botname, global.bc, btn)
                    }
		...
		for (let yoi of anu) {
          ...
          urlButton: {
                  ...
                  url: 'https://github.com/Diegoson/ALEXA-QUEEN-V3'
                      ...
                      let txt = `「 *alexa BROADCAST* 」\n\n${text}`
                      AlexaInc.send5ButImg(yoi, txt, botname, global.bc, btn)
		}
...
case 'bc2': case 'bcloc': {
                if (!isCreator) throw mess.owner
                if (!text) throw `*Type some text*\n\nExample : ${prefix + command} cyberxkid|hi5`
                let anu = await store.chats.all().map(v => v.id)
            ...
            AlexaInc.sendMessage(yoi, { caption: `${melo}`, location: { jpegThumbnail: await getBuffer(picak+'Brodcast') }, buttons: button, footer: `${botname}`, mentions: [m.sender] })
		}		
            }
            break
case 'bcimage': case 'bcvideo': case 'bcaudio': {
                ...
                let anu = await store.chats.all().map(v => v.id)
                let ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "27686881509-1604595598@g.us"}, "message": {orderMessage: {itemCount: 2022,status: 200, thumbnail: fs.readFileSync('./lib/hisoka.jpg'), surface: 200, message: `ALEXA-QUEEN`, orderTitle: 'ALEXA-QUEEN', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
          ...
          quickReplyButton: {
                  ...
                  id: 'menu'
                    ...
                    if (/webp/.test(mime)) {
                    AlexaInc.sendMessage(i, { sticker: { url: media } }, { quoted: ftroli })
                    } else if (/image/.test(mime)) {
                    let junn = `*_BROADCAST IMAGE_*${text ? '\n\n' + text : ''}`
                    AlexaInc.send5ButImg(i, junn, `${global.botname}`, buffer, butoon)
                    } else if (/video/.test(mime)) {
                    let junn = `*_BROADCAST VIDIO_*${text ? '\n\n' + text : ''}`
                    AlexaInc.sendMessage(i, {video: buffer, caption: `${junn}`}, { quoted: ftroli })
                    } else if (/audio/.test(mime)) {
                    AlexaInc.sendMessage(i, {audio: buffer, mimetype: 'audio/mpeg'}, { quoted : ftroli })
                    } else {
...
case 'bcvid': case 'bcvideo': {
		    ...
		    for (let yoi of anu) {
		    await sleep(1500)		    
		    AlexaInc.sendMessage(yoi, { video: await getBuffer(buf), jpegThumbnail: await getBuffer(picak+'Brodcast'), caption: `${text}` }, { quoted: ftroli}).catch ((err) => m.reply('*Sorry, failed to send the video*'))
		}
		m.reply('*Sucecess Broadcast*')
            ...
            //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                ...
                AlexaInc.sendTextWithMentions(m.chat, teks, m)
            }
            break
            case 'q': case 'quoted': {
            if (isBan) throw mess.ban
		...
		if (!isInventoryLimit){ addInventoriLimit(m.sender) }
            ...
            kurangLimit(m.sender, 1)
            m.reply(`*1 limit used*`)
		let wokwol = await AlexaInc.serializeM(await m.getQuotedObj())
            ...
            //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
             ...
             break
                ...
                //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                 ...
                 for (let i of anu) {
                     let metadata = await AlexaInc.groupMetadata(i)
             ...
             //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                    ...
                    AlexaInc.sendText(m.chat, '*LIST ONLINE*:\n\n' + online.map(v => '> @' + v.replace(/@.+/, '')).join`\n`, m, { mentions: online })
             }
            break
            case 'stickerly': {
            if (isBan) throw mess.ban
...
if (isBan) throw mess.ban
            ...
            if (isBan) throw mess.ban
             ...
             if (!quoted) throw `*Reply Video/Image With Caption* ${prefix + command}`
                ...
                let encmedia = await AlexaInc.sendImageAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
                await fs.unlinkSync(encmedia)
            } else if (/video/.test(mime)) {
                if ((quoted.msg || quoted).seconds > 11) return m.reply('*Maximum 10 seconds!*')
                let media = await quoted.download()
                let encmedia = await AlexaInc.sendVideoAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
                await fs.unlinkSync(encmedia)
            } else {
...
AlexaInc.downloadAndSaveMediaMessage(quoted, "gifee")
AlexaInc.sendMessage(m.chat, {sticker:fs.readFileSync("gifee.webp")},{quoted:m})
} else if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await AlexaInc.sendImageAsSticker(m.chat, media, m, { packname: pcknm, author: atnm })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return m.reply('Maksimal 10 detik!')
let media = await quoted.download()
let encmedia = await AlexaInc.sendVideoAsSticker(m.chat, media, m, { packname: pcknm, author: atnm })
await fs.unlinkSync(encmedia)
} else {
...
if (isBan) throw mess.ban
           ...
           if (!isInventoryLimit){ addInventoriLimit(m.sender) }
            ...
            kurangLimit(m.sender, 1)
            m.reply(`*1 limit used*`)
           await AlexaInc.sendMedia(m.chat, `https://cililitan.herokuapp.com/api/attp?teks=${text}`, 'ALEXA', 'QUEEN M D', m, {asSticker: true}).catch((err) => m.reply('*error while sending sticker*'))
         }
         break
case 'attp4': {
if (isBan) throw mess.ban
           ...
           kurangLimit(m.sender, 1)
           m.reply(`*1 limit used*`)
           await AlexaInc.sendMedia(m.chat, `https://api.xteam.xyz/attp?file&teks=${text}`, 'ALEXA', 'QUEEN M D', m, {asSticker: true}).catch((err) => m.reply('*error while sending sticker*'))
                     }
                     break
case 'ttp1': {
if (isBan) throw mess.ban
...
if (!isInventoryLimit){ addInventoriLimit(m.sender) }
            ...
            kurangLimit(m.sender, 1)
            m.reply(`*1 limit used*`)
AlexaInc.sendMessage(m.chat, { sticker : { url : `https://cililitan.herokuapp.com/api/texttopng?teks=${text}`}, quoted: m }).catch((err) => m.reply('*error while sending sticker*'))
} 
break
case 'ttp2': {
if (isBan) throw mess.ban
           if (!text) throw `Example : ${prefix + command} text`
           await AlexaInc.sendMedia(m.chat, `https://cililitan.herokuapp.com/api/texttopng2?teks=${text}`, 'ALEXA', 'QUEEN M D', m, {asSticker: true})
         }
break
		...
		for (let res of anu.results) {
		    let encmedia = await AlexaInc.sendImageAsSticker(m.chat, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
		    await fs.unlinkSync(encmedia)
		}
	    }
	    break
...
////if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
            ...
            m.reply(`*1 limit used*`)   
                ...
                AlexaInc.sendImageAsSticker(m.chat, anu.result.emoji.whatsapp, m, { packname: global.packname, author: global.author }).catch((err) => m.reply(jsonformat('*Sorry there was an error*')))               
                      }
                  break
	       ...
	       if (isBan) throw mess.ban
	        ...
	        let FaTiH = await AlexaInc.sendImageAsSticker(m.chat, smeme, m, { packname: global.packname, author: global.auhor })
...
if (isBan) throw mess.ban
            //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                ...
                exec(`ffmpeg -i ${media} ${ran}`, (err) => {
                    ...
                    AlexaInc.sendMessage(m.chat, { image: buffer, jpegThumbnail:buffer, caption: `*Sticker Toimg By ${botname}*` }, { quoted: m }).catch((err) => m.reply('*Sorry An error occurred*'))
                    fs.unlinkSync(ran)
                })
            }
            break
...
////if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
            ...
            buf = await getBuffer(anu.screenshot)   
                AlexaInc.sendMessage(m.chat, { image: { url: anu.screenshot }, jpegThumbnail:buf, caption: `*${command} From ${text}*` }, { quoted: m }).catch((err) => m.reply(jsonformat('*error*')))
            }
            break
...
//if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
		...
		let { webp2mp4File } = require('./lib/uploader')
                ...
                await AlexaInc.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' } }, { quoted: m })
                await fs.unlinkSync(media)
            }
            break
            ...
            AlexaInc.sendMessage(m.chat, {audio: audio, mimetype: 'audio/mpeg'}, { quoted : m })
            }
            break
            case 'tomp3': {
            if (isBan) throw mess.ban
          //  //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            AlexaInc.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${AlexaInc.user.name}.mp3`}, { quoted : m })
            }
            break
            ...
            AlexaInc.sendMessage(m.chat, {audio: audio, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
            }
            break
            case 'togif': {
            if (isBan) throw mess.ban
          //  //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
		   ...
		   let { webp2mp4File } = require('./lib/uploader')
                let media = await AlexaInc.downloadAndSaveMediaMessage(quoted)
                let webpToMp4 = await webp2mp4File(media)
                await AlexaInc.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' }, gifPlayback: true }, { quoted: m })
                await fs.unlinkSync(media)
            }
            break
	        case 'tourl': {
       ...
       // //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)    
	    ...
	    localFile = await AlexaInc.downloadAndSaveMediaMessage(quoted, hmm)
	    ...
	    AlexaInc.sendMessage(m.chat, {image: fs.readFileSync(outputFile), caption: mess.success}, { quoted : m })
...
AlexaInc.sendMessage(m.chat, { image: yah }, { quoted: m }).catch((err) => m.reply('*Failed in writing*'))
}
break
case 'magernulis': {            
if (isBan) throw mess.ban
		...
		AlexaInc.sendMessage(m.chat, { image: buf, jpegThumbnail:buf, caption: `ALEXA QUEEN` }, { quoted: m }).catch((err) => m.reply('*Sorry Failed In Writing*')) 
	    }
	    break
case 'magernulis2': {            
if (isBan) throw mess.ban
...
case 'stickersearch': {
  ...
  AlexaInc.sendImageAsSticker(m.chat, x, m, { packname: global.packname, author: global.author })      
               }
                }).catch((err) => {
...
AlexaInc.sendMessage(m.chat, { image: yaha, jpegThumbnail:yaha, caption: `${teks}` }, { quoted: m }).catch((err) => m.reply('*Username Not found*'))
}
break
...
`
AlexaInc.sendImage(m.chat, ini_result.avatar, `${ini_txt}`, m).catch((err) => m.reply('*Username Not found*'))
}
break
...
`
AlexaInc.sendImage(m.chat, get_result.profile_picture, `${ini_txt}`, m).catch((err) => m.reply('*Username Not found*'))
}
break
case 'tiktokstalk': {
if (isBan) throw mess.ban
...
`
AlexaInc.sendImage(m.chat, get_result.user_picture, `${ini_txt}`, m).catch((err) => m.reply('*Username Not found*'))
}
break
...
//if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
            ...
            AlexaInc.sendImage(m.chat, x.result[0].thumbnail, `${ini_txt}`, m).catch((err) => m.reply(jsonformat('*Sorry there was an error*')))
            }
            break
case 'brainly': {
if (isBan) throw mess.ban
...
//var kontoll = await getBuffer(anu.result.owner.profile_pic)	
				//sendButLocation(from, `${reply22}`,`© cyberxkid`, {jpegThumbnail:kontoll}, [{buttonId:`${prefix}menu`,buttonText:{displayText:'OKE'},type:1}], {contextInfo: { mentionedJid: [sender, owner]}})
anu = await getBuffer(anu.thumb)
AlexaInc.sendMessage(m.chat, { image: anu, caption: `${reply212}` }, { quoted: m}).catch((err) => m.reply('*No search results found*'))
	            }
                break
case 'font': {
if (isBan) throw mess.ban
...
//if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
          //  if (!text) throw `Example : ${prefix + command} baju`            
            ...
            ini_txt += `*URL* : ${i.url}\n`                 
            AlexaInc.sendImage(m.chat, i.thumb, `${ini_txt}`, m).catch((err) => m.reply(jsonformat('*Sorry there was an error*')))
            }
            break
case 'searchanime': {
if (isBan) throw mess.ban
            ...
            m.reply(`*1 limit used*`)
                ...
                AlexaInc.sendMessage(m.chat, { image: anu, caption: `${command}` }, { quoted: m}).catch((err) => m.reply('*Sorry Xteam server is down*'))
	            }
                break
           ...
           //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
            ...
            break
                ...
                AlexaInc.sendImage(m.chat, anu.result.gambar, `${F}`, m).catch ((err) => m.reply('*Sorry, the feature error is currently*'))
            }
                break
            case 'google': {
...
🔗 *Media Url* : ${images}`,
                ...
                AlexaInc.sendMessage(m.chat, buttonMessage, { quoted: m }).catch((err) => m.reply('*Sorry An error occurred*'))
        })
        }
        break
case 'play': {
...
`
message = await prepareWAMessageMedia({ image : { url: anu.thumbnail } }, { upload:   AlexaInc.waUploadToServer })
...
message = await prepareWAMessageMedia({ image : { url: aramas.videos[0].thumbnail } }, { upload:   AlexaInc.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
...
*⬤▶━━━━━━━━━2:30*\n\n*⬤TITLE :* ${media.title}\n*⬤FILESIZE :* ${media.filesizeF}\n*⬤URL :* ${isUrl(text)}\n*⬤EXT :* MP3\n*⬤RESOLUTION :* ${args[1] || '128kbps'}\n\n*ALEXA QUEEN*`
                ...
                AlexaInc.sendMessage(m.chat, { image: { url: media.thumb }, jpegThumbnail:buf, caption: `${caption}` }, { quoted: m }).catch((err) => m.reply('*Sorry, the link you provided is not valid*'))                
                AlexaInc.sendMessage(m.chat, {document:{url:media.dl_link}, mimetype:"audio/mpeg", fileName: `${media.title}.mp3`,  quoted: m, contextInfo: { externalAdReply:{
                title:media.title,
                body:"YOUTUBE MP3",
                mediaType:2,
                thumbnail:buf,
...
*⬤▶━━━━━━━━━2:30*\n\n*⬤Title* : ${media.title}\n*⬤FILESIZE* : ${media.filesizeF}\n*⬤URL* : ${isUrl(text)}\n*⬤EXT* : MP3\n*⬤RESOLUTION* : ${args[1] || '360p'}\n\n*ALEXA QUEEN*`
                ...
                AlexaInc.sendMessage(m.chat, { image: { url: media.thumb }, jpegThumbnail:buf, caption: `${capti}` }, { quoted: m })
                AlexaInc.sendMessage(m.chat, { video: { url: media.dl_link }, jpegThumbnail:buf, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `*Downloading From ${text}*` }, { quoted: m }).catch((err) => m.reply('*error while sending the video*'))
            }
            break
...
*⬤▶━━━━━━━━━2:30*\n\n\n\n*⬤TITLE:* ${data.title}\n*⬤QUALITY:* ${data.medias[0].quality}\n*⬤SIZE:* ${data.medias[0].formattedSize}\n*⬤DURATION* ${data.duration}\n*⬤ID:* ${data.medias[0].cached}\n*⬤LINK:* ${data.url}\n\n*ALEXA QUEEN*`
  ...
  AlexaInc.sendMessage(m.chat, { image: { url: data.thumbnail }, jpegThumbnail:buf, caption: `${cap}` }, { quoted: m })
  AlexaInc.sendMessage(m.chat, { video: { url: data.medias[0].url }, jpegThumbnail:buf, caption: `*⬤TITLE:* ${data.title}\n*⬤QUALITY:* ${data.medias[0].quality}\n*⬤SIZE:* ${data.medias[0].formattedSize}` }, { quoted: m })  
                }).catch((err) => {
	   ...
	   // //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
		...
		let urls = quoted.text.match(new RegExp(/(?:https?:\/\/)?(?:youtu\.be\/|(?:www\.|m\.)?youtube\.com\/(?:watch|v|embed|shorts)(?:\.php)?(?:\?.*v=|\/))([a-zA-Z0-9\_-]+)/, 'gi'))
            ...
            m.reply(`*1 limit used*`)
                ...
                if (media.filesize >= 100000) return m.reply('*File Over Limit* '+util.format(media))
                AlexaInc.sendImage(m.chat, media.thumb, `*⬤TITLE* : ${media.title}\n*⬤FILE SIZE :* ${media.filesizeF}\n*⬤URL :* ${urls[text - 1]}\n*⬤EXT :* MP3\n*⬤RESOLUTION :* ${args[1] || '128kbps'}`, m)
                AlexaInc.sendMessage(m.chat, { audio: { url: media.dl_link }, mimetype: 'audio/mpeg', fileName: `${media.title}.mp3` }, { quoted: m })
            }
            break
            case 'getvideo': {          
            if (isBan) throw mess.ban
            ...
            m.reply(`*1 limit used*`)
                ...
                if (media.filesize >= 100000) return m.reply('*File Over Limit* '+util.format(media))
                AlexaInc.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `*⬤TITLE :* ${media.title}\n*⬤FILESIZE :* ${media.filesizeF}\n*⬤URL :* ${urls[text - 1]}\n*⬤EXT:* MP3\n*⬤RESOLUTION :* ${args[1] || '360p'}` }, { quoted: m })
            }
            break
...
if (isBan) throw mess.ban
          ...
          case 'venus': case 'viewfinder': case 'warmsunset': {
            ...
            m.reply(`*1 limit used*`)
                ...
                AlexaInc.sendMessage(m.chat, { image: buf, jpegThumbnail:buf, caption: `PhotoFilter ${command}` }, { quoted: m}).catch ((err) => m.reply('*Sorry failed to create a filter*'))
                }
                break
           case 'quotemaker': {
if (isBan) throw mess.ban
            ...
            m.reply(`*1 limit used*`)
                ...
                AlexaInc.sendMessage(m.chat, { image: anu, jpegThumbnail:anu, caption: `*${command}*` }, { quoted: m }).catch ((err) => m.reply('*Sorry for the feature error*'))
                }
           break
           case 'gaming': {
if (isBan) throw mess.ban
...
if (isBan) throw mess.ban
            ...
            m.reply(`*1 limit used*`)
                ...
                AlexaInc.sendMessag0 (m.chat, { image: anu, jpegThumbnail:anu, caption: `*${command}*` }, { quoted: m }).catch ((err) => m.reply('*Sorry for the feature error*'))
                }
           break
           case 'yotsuba': {
                if (!isInventoryLimit){ addInventoriLimit(m.sender) }
        ...
        case 'cry':case 'kill':case 'hug':case 'pat':case 'lick':case 'kiss':case 'bite':case 'yeet':case 'neko':case 'bully':case 'bonk':case 'wink':case 'poke':case 'nom':case 'slap':case 'smile':case 'wave':case 'awoo':case 'blush':case 'smug':case 'glomp':case 'happy':case 'dance':case 'cringe':case 'cuddle':case 'highfive':case 'shinobu':case 'megumin':case 'handhold':
					...
					.then(({data}) => {
						AlexaInc.sendImageAsSticker(m.chat, data.url, m, { packname: global.packname, author: global.author })
                    })
                    break 
    ...
    break
	    ...
	    if (isBan) throw mess.ban
            ...
            m.reply(`*1 limit used*`)
                ...
                let random = anu[Math.floor(Math.random() * anu.length)]
                AlexaInc.sendMessage(m.chat, { image: { url: random.male }, caption: `Couple Male` }, { quoted: m })
                AlexaInc.sendMessage(m.chat, { image: { url: random.female }, caption: `Couple Female` }, { quoted: m })
            }
	    break        
		...
		let buttons = [
            ...
            break                  //by cyberxkid if you copy give credits
            case 'slot': { 
                const sotoy = [
                    '🍊 : 🍒 : 🍐 *YOU LOSE BRO*',
                    '🍒 : 🔔 : 🍊 *YOU LOSE BRO*',
                    ...
                    AlexaInc.sendMessage(from, { image: buffer, caption: '*SLOT MACHINE*\n'+ cyberxkidlot }, {quoted:m})
                }
...
AlexaInc.sendMessage(m.chat, {image: await getBuffer(peh)}, {quoted:m}).catch ((err) => m.reply('error'))     
}
break
     ...
     if (isBan) throw mess.ban
            ...
            m.reply(`*1 limit used*`)
                ...
                AlexaInc.sendMessage(m.chat, { image: anu, caption: `Text Pro ${command}` }, { quoted: m}).catch((err) => m.reply('*Sorry Xteam server is down*'))
	            }
                break
                case 'nsfw': {
                 ...
                 AlexaInc.sendMessage(from, {text: `*horny mood activated everyone be ready for masturbation*`, contextInfo: { mentionedJid : mems }}, {quoted:m})
                 } else if (args[0] === "off") {
                 if (!isAntinsfw) return reply('*Already deactivated*')
                 let off = cyberxkidno.indexOf(from)
                 cyberxkidno.splice(off, 1)
                 reply('*Success turning off horny mood in this group*')
                  ...
                  AlexaInc.sendMessage(m.chat, {image:fuckyou}, { quoted: m })
     ...
     if (isBan) throw mess.ban
            ...
            anu = await getBuffer(`https://violetics.pw/api/photooxy/${command}?apikey=${setting.violkey}&text=${text}`)
                AlexaInc.sendMessage(m.chat, { image: anu, caption: `*PHOTO OXY ${command}*` }, { quoted: m}).catch((err) => m.reply('*Sorry Xteam server is down*'))
	            }
                break
     ...
     if (isBan) throw mess.ban
            ...
            m.reply(`*1 limit used*`)
                ...
                AlexaInc.sendMessage(m.chat, { image: buf, caption: `Effect ${command}` }, { quoted: m}).catch ((err) => m.reply('error'))
                }
                break
                //TRUTH OR DARE
...
if (isBan) throw mess.ban
            ...
            m.reply(`*1 limit used*`)
                ...
                AlexaInc.sendMessage(m.chat, { image: anu, caption: `*EPHOTO ${command}*` }, { quoted: m}).catch((err) => m.reply('*Sorry Xteam server is down*'))
	            }
                break
...
//ALEXA QUEEN
	    ...
	    ////if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
            ...
            m.reply(`*1 limit used*`)
                ...
                if (anu.status == false) return m.reply(anu.message)
                AlexaInc.sendText(m.chat, `> *Dream :* ${anu.message.mimpi}\n> *ARTI :* ${anu.message.arti}\n> *SOLUTION :* ${anu.message.solusi}`, m)
            }
            break
            ...
            m.reply(`*1 limit used*`)
                ...
                if (anu.status == false) return m.reply(anu.message)
                AlexaInc.sendText(m.chat, `> *NAME :* ${anu.message.nama}\n> *ARTI :* ${anu.message.arti}\n> *NOTES :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'jadianpernikahan': case 'jadiannikah': {
             //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                ...
                if (anu.status == false) return m.reply(anu.message)
                AlexaInc.sendText(m.chat, `> *Tanggal Pernikahan :* ${anu.message.tanggal}\n> *characteristics:* ${anu.message.karakteristik}`, m)
            }
            break
            case 'sifatusaha': {
             //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                ...
                if (anu.status == false) return m.reply(anu.message)
                AlexaInc.sendText(m.chat, `> *Born :* ${anu.message.hari_lahir}\n> *Effort :* ${anu.message.usaha}`, m)
            }
            break
            ...
            case 'artitarot': case 'tarot': {
             //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                ...
                if (anu.status == false) return m.reply(anu.message)
                AlexaInc.sendImage(m.chat, anu.message.image, `> *Born :* ${anu.message.tgl_lahir}\n> *Symbol tart :* ${anu.message.simbol_tarot}\n> *Arti :* ${anu.message.arti}\n> *NOTES* ${anu.message.catatan}`, m)
            }
            break
            case 'fengshui': {
             //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
            ...
            case 'haribaik': {
             //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                ...
                if (anu.status == false) return m.reply(anu.message)
                AlexaInc.sendText(m.chat, `> *Born :* ${anu.message.tgl_lahir}\n> *Kala Tinantang :* ${anu.message.kala_tinantang}\n> *Info :* ${anu.message.info}\n> *NOTES* ${anu.message.catatan}`, m)
            }
            break
            ...
            //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                ...
                if (anu.status == false) return m.reply(anu.message)
                AlexaInc.sendText(m.chat, `> *Date :* ${anu.message.tgl_memancing}\n> *Results :* ${anu.message.result}\n> *NOTES* ${anu.message.catatan}`, m)
            }
            break
            case 'masasubur': {
             //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                ...
                if (anu.status == false) return m.reply(anu.message)
                AlexaInc.sendText(m.chat, `> *Results :* ${anu.message.result}\n> *NOTES* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'shio': {
             //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                ...
                if (anu.status == false) return m.reply(anu.message)
                AlexaInc.sendText(m.chat, `> *Results :* ${anu.message}`, m)
            }
            break
	 ...
	 //   //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
		//if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply('Limit Harian Anda Telah Habis')
		    ...
		    db.data.users[m.sender].limit -= 1
                    ...
                    if (anu.status == false) return m.reply(anu.result.message)
                    AlexaInc.sendMedia(m.chat, anu.caption.profile_hd, '', `> Full Name : ${anu.caption.full_name}\n> User Name : ${anu.caption.user_name}\n> ID ${anu.caption.user_id}\n> Followers : ${anu.caption.followers}\n> Following : ${anu.caption.following}\n> Bussines : ${anu.caption.bussines}\n> Profesional : ${anu.caption.profesional}\n> Verified : ${anu.caption.verified}\n> Private : ${anu.caption.private}\n> Bio : ${anu.caption.biography}\n> Bio Url : ${anu.caption.bio_url}`, m)
		    db.data.users[m.sender].limit -= 1
...
let message = await prepareWAMessageMedia({ video: buf2, gifPlayback:false, jpegThumbnail:buf }, { upload: AlexaInc.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
...
url: 'https://www.youtube.com/c/CYBERXKID'
}
}, {
urlButton: {
displayText: 'GITHUB',
            ...
            m.reply(`*1 limit used*`)
                ...
                bocil.tiktokdlv3(`${text}`).then(async (video) => {           
                  ...
                  *▊▊▊TIKTOK DL▊▊▊*\n\n*AUTHOR* : CYBERXKID\n*NICKNAME* : ${video.author.nickname}\n*CAPTION* : ${video.description}\n*QUALITY* : nowatermark\n*COMMENTS* : ${memek}\n*CREATE* ${hadir} Ago\n*LIKES* : ${hadi}\n*DISLIKE* : ${hadie}\n*SOURCE* : ${text}\n\n\n*ALEXA QUEEN*`
                  ...
                  AlexaInc.sendMessage(m.chat, { image: { url: video.author.avatar }, jpegThumbnail:buf, caption: `${caption}` }, { quoted: m })
                  AlexaInc.sendMessage(m.chat, { video: { url: video.video.no_watermark }, jpegThumbnail:buf, mimetype: 'video/mp4', caption: `*Downloading From ${text}*` }, { quoted: m })               
                }).catch((err) => {
                    m.reply(`*Failed to download media and send videos*`)
                })
            }
...
case 'tt3': case 'tiktok3': {
            ...
            m.reply(`*1 limit used*`)
                ...
                bocil.tiktokdlv3(`${text}`).then(async (video) => {           
                  ...
                  let caption = `**▊▊▊TIKTOK DL▊▊▊**\n\n*⬤AUTHOR* : CYBERXKID\n*⬤NICKNAME* : ${video.author.nickname}\n*⬤CAPTION* : ${video.description}\n*⬤COMMENTS* : ${memek}\n*⬤CREATE* ${hadir} Ago\n*⬤LIKES* : ${hadi}\n*⬤DISLIKES* : ${hadie}\n*⬤ SOURCE* : ${text}`
                  buf = await getBuffer(video.author.avatar)                
                  let message = await prepareWAMessageMedia({ image: buf, jpegThumbnail: buf }, { upload: AlexaInc.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
case 'tiktokmp3': case 'tiktokaudio': { 	   
          if (isBan) throw mess.ban
            ...
            m.reply(`*1 limit used*`)
                ...
                AlexaInc.sendMessage(m.chat, { audio: { url: data.result.nowatermark }, mimetype: 'audio/mp4'}, { quoted: m })
                }).catch((err) => {
...
if (!text) throw `*Enter link tiktok example ${prefix + command} https://vt.tiktok.com/zgjbtcsdq/`  
            ...
            m.reply(`*1 limit used*`)           
                ...
                AlexaInc.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
                }).catch((err) => {
                    m.reply(`*Failed to download media and send videos*`)
                })
            }
...
case 'ig': case 'igdl': case 'instagram': {
            ...
            m.reply(`*1 limit used*`)                
	            ...
	            AlexaInc.sendMessage(m.chat, { image: { url: result.user.profilePicUrl }, jpegThumbnail: await getBuffer(result.user.profilePicUrl), caption: `*----「 INSTAGRAM DOWNLOADER 」----*\n\n*⬤ Username :* ${result.user.username}\n*⬤ Fullname :* ${result.user.fullName}\n*⬤ Followers :* ${result.user.followers}\n*⬤ Following :* ${result.user.following}\n*⬤ ID :* ${result.user.id}\n*⬤ Filetype :* ${result.medias[0].fileType}\n*⬤ Type :* ${result.medias[0].type}\n*⬤ Jumlah Media :* ${result.medias.length}\n*⬤ Url :* ${text}\n\n*ALEXA QUEEN*` }, { quoted: m })	             	                      	            
                ...
                AlexaInc.sendMessage(m.chat, { video: link, jpegThumbnail: await getBuffer(i.preview), caption: `*Instagram ${i.type}*` }, { quoted: m })
                ...
                AlexaInc.sendMessage(m.chat, { image: link, jpegThumbnail: await getBuffer(i.preview), caption: `*Instagram ${i.type}*` }, { quoted: m })          
            ...
            m.reply(`*1 limit used*`)
			    ...
			    if(i.url.includes('mp4')){
				let link = await getBuffer(i.url)
                AlexaInc.sendMessage(m.chat, { video: link, jpegThumbnail: await getBuffer(i.thumbnail), caption: `*${botname}*` }, { quoted: m }) 
                } else {
                    let link = await getBuffer(i.url)
                  AlexaInc.sendMessage(m.chat, { image: link, jpegThumbnail: await getBuffer(i.thumbnail), caption: `*${botname}*` }, { quoted: m })                  
                }
            }
...
case 'ig2': case 'igdl2': case 'instagram2': {	            
            ...
            for(let i of anu.medias){                
                ...
                AlexaInc.sendMessage(m.chat, { image: { url: anu.user.profilePicUrl }, jpegThumbnail:buf, caption: `${txt}` }, { quoted: m }).catch((err) => m.reply('error'))
                AlexaInc.sendMessage(m.chat, { video: { url: i.url }, jpegThumbnail:buf, caption: `${botname}`}, { quoted: m }).catch((err) => m.reply('error'))
               }
            }
            break
            case 'igimage': {	            
            ...
            m.reply(`*1 limit used*`)
                ...
                for (let f of data) {                    
                AlexaInc.sendMedia(m.chat, f.url, '', `Download Url Instagram From ${text}`, m)
                }
                }).catch((err) => {
                    m.reply(`*Failed to download media and send videos*`)
                })
            ...
            m.reply(`*1 limit used*`)              
	            ...
	            AlexaInc.sendMessage(m.chat, { image: { url: result.user.profilePicUrl }, jpegThumbnail: await getBuffer(result.user.profilePicUrl), caption: `*----「 INSTAGRAM STORY 」----*\n\n*⬤ Username :* ${result.user.username}\n*⬤ Fullname :* ${result.user.fullName}\n*⬤ Followers :* ${result.user.followers}\n*⬤ Following :* ${result.user.following}\n*⬤ ID :* ${result.user.id}\n*⬤ Filetype :* ${result.medias[0].fileType}\n*⬤ Type :* ${result.medias[0].type}\n*⬤ Media :* ${result.medias.length}\n*⬤ Bio :* ${result.user.biography}\n\n*ALEXA QUEEN*` }, { quoted: m })	             	                      	            
                ...
                AlexaInc.sendMessage(m.chat, { video: link, jpegThumbnail: await getBuffer(i.preview), caption: `*Story ${i.type}*` }, { quoted: m }) 

                } else {

                    let link = await getBuffer(i.url)

                  AlexaInc.sendMessage(m.chat, { image: link, jpegThumbnail: await getBuffer(i.preview), caption: `*Story ${i.type}*` }, { quoted: m })                  
...
case 'igs2': case 'igstory2': case 'instagramstory2':{
            ...
            m.reply(`*1 limit used*`)
                ...
                AlexaInc.sendMessage(m.chat, { video: { url: i.url }, jpegThumbnail:tummb, caption: `*${botname}*`}, { quoted: m }).catch((err) => m.reply('*Sorry, the feature is in error*'))
                }
            }
            break
case 'igs3': case 'igstory3': case 'instagramstory3': {
            ...
            m.reply(`*1 limit used*`)
	            ...
	            .then(async(result) => {	  
	            var halo = 1		
	            AlexaInc.sendMessage(m.chat, { image: { url: result.user.profilePicUrl }, jpegThumbnail: await getBuffer(result.user.profilePicUrl), caption: `*----「 INSTA DOWNLOADER 」----*\n\n*⬤ Username :* ${result.user.username}\n*⬤ Fullname :* ${result.user.fullName}\n*⬤ Followers :* ${result.user.followers}\n*⬤ Following :* ${result.user.following}\n*⬤ ID :* ${result.user.id}\n*⬤ Jumlah Media :* ${halo++}\n*⬤ Bio :* ${result.user.biography}\n\n*ALEXA QUEEN*` }, { quoted: m })	             	                      	            
		        for(let i of result.results) {		
		        if(i.url.includes('mp4')){		           			    				
				let link = await getBuffer(i.sourceUrl)
                AlexaInc.sendMessage(m.chat, { video: link, jpegThumbnail: await getBuffer(i.thumbnail), caption: `*Story ${i.type}*` }, { quoted: m })
                } else {
                let link = await getBuffer(i.url)
                AlexaInc.sendMessage(m.chat, { image: link, jpegThumbnail: await getBuffer(i.thumbnail), caption: `*Story ${i.type}*` }, { quoted: m })          
               }
              }
            ...
            m.reply(`*1 limit used*`)
                ...
                AlexaInc.sendMessage(m.chat, { video: { url: data[0].url }, jpegThumbnail:buf, caption: `${botname}`}, { quoted: m })
                }).catch((err) => {
                    m.reply(`*Failed to download media and send videos*`)
                })
            }
            ...
            m.reply(`*1 limit used*`)
                ...
                AlexaInc.sendMessage(m.chat, { image: { url: anu.result.image }, jpegThumbnail:buf, caption: `${msg}` }, { quoted: m }).catch((err) => m.reply('*Sorry An error occurred*'))
                AlexaInc.sendMessage(m.chat, { audio: { url: anu.result.audio[0].link }, mimetype: 'audio/mpeg' }, { quoted: m }).catch((err) => m.reply('*Sorry An error occurred*'))
            }
            break
            ...
            m.reply(`*1 limit used*`)
                xa.SoundCloud(`${text}`).then(async (data) => {
                    ...
                    txt += `*ALEXA QUEEN*`
                buf = await getBuffer(data.thumbnail)   
                AlexaInc.sendMessage(m.chat, { image: { url: data.thumbnail }, jpegThumbnail:buf, caption: `${txt}` }, { quoted: m }).catch((err) => m.reply('link error'))    
                AlexaInc.sendMessage(m.chat, { audio: { url: data.medias[0].url }, mimetype: 'audio/mpeg', fileName: data.title+'.m4a' }, { quoted: m })
                }).catch((err) => {
                    m.reply(`*Failed to download media and send audio*`)
                })
            }
...
*Mime* : ${baby1[0].mime}
*Link* : ${baby1[0].link}\n
_whoa wait helixbot processing..._

*ALEXA QUEEN*`
m.reply(`${result4}`)
AlexaInc.sendMessage(m.chat, { document : { url : baby1[0].link}, fileName : baby1[0].nama, mimetype: baby1[0].mime }, { quoted : m }).catch ((err) => m.reply('*Failed to download File*'))
}
break
case 'savefrom': {
  ...
  const sendm =  KichuBotInc.sendMessage(
...

      {
       ...
       sections
            ...
            m.reply(`*1 limit used*`)
                ...
                AlexaInc.sendMessage(m.chat, { video: link, caption: `*quality ${i.subname}*` }, { quoted: m })                  
...
AlexaInc.sendMessage(m.chat, {video: await getBuffer(anu.result.resurl), mimetype: 'video/mp4'}, {quoted:m}).catch ((err) => m.reply('Failed to download File'))     
}
break
case 'smule': {
...
AlexaInc.sendMessage(m.chat, {video: await getBuffer(anu.result[0]), mimetype: 'video/mp4'}, {quoted:m}).catch ((err) => m.reply('*Failed to download File*'))     
...
AlexaInc.sendMessage(m.chat, {video: await getBuffer(anu.result.hd.url), mimetype: 'video/mp4'}, {quoted:m}).catch ((err) => m.reply('*Failed to download File*'))     
}
break
case 'zippyshare': {
////if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
...
AlexaInc.sendMessage(m.chat, {document: linkyke, mimetype: 'application/zip', fileName: `${anu.result.filename}`}, {quoted:m}).catch ((err) => m.reply('*Failed to download File*'))     
}
break
case 'googledrive': {
////if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
...
m.reply(`${util.format(anu)}`)
AlexaInc.sendMessage(m.chat, {document: await getBuffer(anu.result.server2), mimetype: 'application/zip', fileName: `${anu.result.title}`}, {quoted:m}).catch ((err) => m.reply('*Failed to download File*'))     
}
break
case 'imagetopdf': {
////if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
...
if (!isInventoryLimit){ addInventoriLimit(m.sender) }
            ...
            m.reply(`*1 limit used*`)
let { UploadFileUgu, webp2mp4File, TelegraPh } = require('./lib/uploader')
                let medi = await AlexaInc.downloadAndSaveMediaMessage(quoted)                
                let anu = await TelegraPh(medi)            
hayo = `https://xteam.xyz/imagetopdf?url=${anu}&APIKEY=${setting.riy}`
AlexaInc.sendMessage(m.chat, {document: await getBuffer(hayo), mimetype: 'application/pdf', fileName: `${botname}.pdf`}, {quoted:m}).catch ((err) => m.reply('*Failed to download File*'))     
}
break
case 'twitter': case 'td': case 'twitterdl': {     	             
            ...
            m.reply(`*1 limit used*`)
                xa.Twitter(`${text}`).then(async (data) => {                    
                    ...
                    txt += `*ALEXA QUEEN*`
                buf = await getBuffer(data.thumbnail)    
                AlexaInc.sendMessage(m.chat, { image: { url: data.thumbnail }, jpegThumbnail:buf, caption: `${txt}` }, { quoted: m })
                for (let i of data.medias) {
                AlexaInc.sendMessage(m.chat, { video: { url: i.url }, jpegThumbnail:buf, caption: `*Downloading From ${text}*`}, { quoted: m })
                }
                }).catch((err) => {
                    m.reply(`*Failed to download media and send videos*`)
                })
...
case 'twitter2': case 'td2': case 'twitterdl2': {     	             
            ...
            m.reply(`*1 limit used*`)
                ...
                buf = await getBuffer(data.thumbnail)    
                AlexaInc.sendMessage(m.chat, { video: { url: x.url }, jpegThumbnail:buf, caption: `${txt}`}, { quoted: m })
                }
...
case 'twittermp3': case 'twitteraudio': { 	             
            ...
            m.reply(`*1 limit used*`)
                xa.Twitter(`${text}`).then(async (data) => {
               AlexaInc.sendMessage(m.chat, { audio: { url: data.medias[1].url }, mimetype: 'audio/mp4'}, { quoted: m })
                }).catch((err) => {
                    m.reply(`*Failed to download media and send audio*`)
                })
            }
...
case 'fbdl': case 'fb': case 'facebook': case 'pesbuk': {     	    
            ...
            let bocil = require('@bochilteam/scraper')  
                ...
                AlexaInc.sendMessage(m.chat, { video: { url: i.url }, jpegThumbnail:buf, caption: `*⬤ Quality :* ${i.quality}`}, { quoted: m })
...
case 'fbmp3': case 'facebookmp3': case 'facebookaudio': {
  ...
  AlexaInc.sendMessage(m.chat, { audio: { url: anu.url[0].url }, mimetype: 'audio/mp4' }, { quoted: m })      
                }).catch((err) => {
...
case 'fb6': {   	    
            ...
            m.reply(`*1 limit used*`)            
                ...
                buf = await getBuffer(data.thumbnail)    
                AlexaInc.sendMessage(m.chat, { image: { url: data.thumbnail }, jpegThumbnail:buf, caption: `${txt}` }, { quoted: m })              
                AlexaInc.sendMessage(m.chat, { video: { url: data.medias[1].url }, jpegThumbnail:buf, caption: `*⬤ Quality :* ${data.medias[1].quality}`}, { quoted: m })                
                }).catch((err) => {
                    m.reply(`*Failed When Downloading Media and Sending Files*`)
                })
            }
            ...
            m.reply(`10 limit terpakai`)
                ...
                AlexaInc.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `${anu.title}`}, { quoted : m }).catch((err) => m.reply('*Sorry, the feature is in error*'))
                AlexaInc.sendMessage(m.chat, { video: { url: anu.video }, jpegThumbnail:tummb, caption: `${util.format(anu)}`}, { quoted: m }).catch((err) => m.reply('*Sorry, the feature is in error*'))
            }
            break
            ...
            m.reply(`*1 limit used*`)
                ...
                AlexaInc.sendMessage(m.chat, { video: { url: anu.medias[0].url }, jpegThumbnail:tummb, caption: `${util.format(anu)}`}, { quoted: m }).catch((err) => m.reply('*Sorry, the feature is in error*'))
            }
            break
...
case 'fb2': case 'facebook2': {
            ...
            m.reply(`*1 limit used*`)
                ...
                AlexaInc.sendMessage(m.chat, { video: { url: anu.result.url[0].url }, jpegThumbnail:tummb, caption: `*📽️ FACEBOOK DOWNLOADER*\n\n*Name* : ${anu.result.meta.title}\n*Quality* : ${anu.result.url[0].subname}\n*Ext* : ${anu.result.url[0].ext}\n`}, { quoted: m }).catch((err) => m.reply('*Sorry, the feature is in error*'))
            }
            break
  ...
  AlexaInc.sendMessage(m.chat, { video: { url: data.data.url }, caption: `${data.data.file}` }, { quoted: m })  
                }).catch((err) => {
                    m.reply(`*${text}  ALEXA QUEEN*`)
                })
            }
            break
...
break
           ...
           // //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)                       
            ...
            if (!args[0]) throw 'link github  EXAMPLE: https://github.com/Diegoson/ALEXA-QUEEN-V3'
    ...
    AlexaInc.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' }, { quoted: m }).catch((err) => m.reply('*Sorry, the github link you provided is private, and cant be made into a file*'))
			break    
...
`,
		    ...
		    AlexaInc.sendMessage(m.chat, { image: { url }, caption: `> Title : ${anu.title}\n> Author : ${anu.author.name}\n> Like : ${anu.like}\n> Caption : ${anu.caption}` }, { quoted: m })
		    })
		}
	    }
	    break
...
//BY ALEXA QUEEN
        ...
        case 'resepmasakan2': {
				...
				if (!text) throw `Example : ${prefix + command} Nasi padang`
					...
					AlexaInc.sendImage(m.chat, anu.results.thumb, `${hasilresep}`, m).catch((err) => m.reply('*Sorry, the feature is in error*'))
					}
		break
case 'resep': case 'resepmasakan': {
  ...
  const sendm =  AlexaInc.sendMessage(
      m.chat, 
      {
...
case 'makanan': {
            ...
            m.reply(`*1 limit used*`)
                ...
                AlexaInc.sendMessage(m.chat, { image: { url: anu.results[3].thumb }, jpegThumbnail:buf, caption: `${util.format(anu)}` }, { quoted: m }).catch((err) => m.reply('error'))
}
break
...
if (!isInventoryLimit){ addInventoriLimit(m.sender) }
           ...
           for (let i of anu) {    
           linkye = `*▊▊▊APK DOWNLOAD▊▊▊*\n\n*TITLE:* ${i.title}\n*UPDATE:* ${i.up}\n*VERSION:* ${i.vers}\n*FILESIZE:* ${i.size}\n*URL:* \n*DESCRIPTION:* ${i.desc}\n\n*ALEXA QUEEN*`         
                AlexaInc.sendMessage(m.chat, { image: await getBuffer(i.thumb), jpegThumbnail: await getBuffer(i.thumb), caption: `${linkye}` }, { quoted: m })
                AlexaInc.sendMessage(m.chat, {document: await getBuffer(i.link), mimetype: `application/vnd.android.package-archive`, fileName: `${i.title}`}, {quoted:m})  
                }  
                }).catch((err) => {
                    m.reply(`*Failed When Downloading Media and Sending Files*`)
                }) 
                ...
                break
case 'tagme': {
AlexaInc.sendMessage(m.chat, {text:`@${m.sender.split("@")[0]}`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
}

break
        case 'wiki': case 'wikipedia': {
       // //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                if (!text) throw `Example : ${prefix + command} diegoson alexa queen v3'
                if (!isInventoryLimit){ addInventoriLimit(m.sender) }
            if (isLimit < 1) return m.reply(mess.endLimit)
            kurangLimit(m.sender, 1)
            m.reply(`*1 limit used*`)
		...
		let result = anu[Math.floor(Math.random() * anu.length)]
		AlexaInc.sendMessage(m.chat, { audio: { url: result.audio }, fileName: result.title+'.mp3', mimetype: 'audio/mpeg' }, { quoted: m })
	    }
	    break
		case 'iqra': {
		//if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
		...
		AlexaInc.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf`}, {quoted:m}).catch ((err) => m.reply(oh))
		}
		break
		case 'juzamma': {
		//if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
		if (args[0] === 'pdf') {
		m.reply(mess.wait)
	    AlexaInc.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pdf'}, mimetype: 'application/pdf', fileName: 'juz-amma-arab-latin-indonesia.pdf'}, {quoted:m})
		} else if (args[0] === 'docx') {
		m.reply(mess.wait)
		AlexaInc.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.docx'}, mimetype: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', fileName: 'juz-amma-arab-latin-indonesia.docx'}, {quoted:m})
		} else if (args[0] === 'pptx') {
		m.reply(mess.wait)
		AlexaInc.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx'}, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: 'juz-amma-arab-latin-indonesia.pptx'}, {quoted:m})
		} else if (args[0] === 'xlsx') {
		m.reply(mess.wait)
		AlexaInc.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.xlsx'}, mimetype: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', fileName: 'juz-amma-arab-latin-indonesia.xlsx'}, {quoted:m})
		} else {
...
Alexa Inc.sendMessage(m.chat, { audio: ini_buffer, mimetype: 'audio/mpeg', fileName: `mp3` }, { quoted: m }).catch ((err) => m.reply('*error while sending the audio*'))
}
break
...
( Q.S ${res.result.data.surah.name.transliteration.id} : ${res.result.data.number.inSurah} )`
		m.reply(txt)
		AlexaInc.sendMessage(m.chat, {audio: { url: res.result.data.audio.primary }, mimetype: 'audio/mpeg'}, { quoted : m })
		}
		break
		case 'tafsirsurah': {
		//if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
		...
		break
		  ...
		  if (!isInventoryLimit){ addInventoriLimit(m.sender) }
            ...
            m.reply(`*1 limit used*`)
                ...
                if (/audio/.test(mime)) {
                m.reply(mess.wait)
                let media = await KichuBotInc.downloadAndSaveMediaMessage(quoted)
                let ran = getRandom('.mp3')
                exec(`ffmpeg -i ${media} ${set} ${ran}`, (err, stderr, stdout) => {
                fs.unlinkSync(media)
                if (err) return m.reply(err)
                let buff = fs.readFileSync(ran)
                KichuBotInc.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : m })
                fs.unlinkSync(ran)
                })
...
`.trim()
                AlexaInc.sendText(m.chat, teks, m, { mentions: Object.values(global.db.data.sticker).map(x => x.mentionedJid).reduce((a,b) => [...a, ...b], []) })
            }
            break
            case 'lockcmd': {            
                if (!isCreator) throw mess.owner
...
*View list of Messages With* ${prefix}listmsg`)
          ...
          //  //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
            ...
            m.reply(`*1 limit used*`)
                ...
                Alexanc.copyNForward(m.chat, msgs[text.toLowerCase()], true)
            }
            break
            case 'listmsg': {
            //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
...
//BY ALEXA QUEEN
            ...
            case 'gg': {
                //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                if (!text) throw `Example : ${prefix + command} https://github.com`
                anu = await fetchJson(`https://xteam.xyz/shorturl/gg?url=${text}&nama=cyberxkid&APIKEY=${setting.riy}`)
                m.reply(`${anu.result}`)
            }
            break
            case 'sid': {
                //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                if (!text) throw `Example : ${prefix + command} https://github.com`
                anu = await fetchJson(`https://xteam.xyz/shorturl/sid?url=${text}&nama=cyberxkid&APIKEY=${setting.riy}`)
                m.reply(`${anu.result}`)
            }
            break
            case 'cuttly': {
                //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                if (!text) throw `Example : ${prefix + command} https://github.com`
                anu = await fetchJson(`https://xteam.xyz/shorturl/cuttly?url=${text}&nama=cyberxkid&APIKEY=${setting.riy}`)
                m.reply(`${anu.result}`)
            }
            break
...
//BY ALEXA QUEEN
	    ...
	    case 'anonymous': {
	     //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                ...
                Alexanc.sendButtonText(m.chat, buttons, `\`\`\`Hi ${await AlexsInc.getName(m.sender)} Welcome To Anonymous Chat\n\nClick the button below to find a partner\`\`\``, AlexaInc.user.name, m)
            }
			break
            case 'keluar': case 'leave': {
             //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                ...
                if (!room) {
                    ...
                    await AlexaInc.sendButtonText(m.chat, buttons, `\`\`\`*You are not in an anonymous session, press the button to find a partner* \`\`\``)
                    throw false
                }
                m.reply('Ok')
                let other = room.other(m.sender)
                if (other) await AlexaInc.sendText(other, `\`\`\`*Partner Has Left Anonymous Session*\`\`\``, m)
            ...
            case 'mulai': case 'start': {
             //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                ...
                if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
                    ...
                    await AlexaInc.sendButtonText(m.chat, buttons, `\`\`\`*You are still in an anonymous session, press the button below to terminate your anonymous session*\`\`\``, AlexaInc.user.name, m)
                    throw false
                }
                ...
                if (room) {
                    ...
                    await AlexaInc.sendButtonText(room.a, buttons, `\`\`\`*Successfully Found Partner, now you can send message*\`\`\``, AlexaInc.user.name, m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await AlexaInc.sendButtonText(room.b, buttons, `\`\`\`Successfully Found Partner, now you can send message\`\`\``, AlexaInc.user.name, m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await AlexaInc.sendButtonText(m.chat, buttons, `\`\`\`*Please wait, looking for a partner*\`\`\``, AlexaInc.user.name, m)
                }
                break
            }
            case 'next': case 'lanjut': {
             //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                ...
                if (room) {
                    ...
                    await AlexaInc.sendButtonText(m.chat, buttons, `\`\`\`*Please Wait Looking For Partner*\`\`\``, AlexaInc.user.name, m)
                }
                break
            }
            case 'public': {
                if (!isCreator) throw mess.owner
                AlexaInc.public = true
                m.reply('*Bot working as public now hope you will enjoy*')
            }
            break
            case 'self': {
                if (!isCreator) throw mess.owner
                AlexaInc.public = false
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
            ...
            case 'owner': case 'creator': {
                AlexaInc.sendContact(m.chat, global.owner, m)
                const devsound = fs.readFileSync('./alexa/bot.mp3')
           AlexaInc.sendMessage(m.chat, { audio: devsound, mimetype: 'audio/mp4', ptt: true, quoted: m })
            
            }
            
            break
            case 'developer': case 'botdev': {
                AlexaInc.sendContact(m.chat, global.botdev, m)
                const devsound = fs.readFileSync('./alexa/bot.mp3')
          AlexaInc.sendMessage(m.chat, { audio: devsound, mimetype: 'audio/mp4', ptt: true, quoted: m })
            }
            ...
            case 'bothelp':  {
                AlexaInc.sendContact(m.chat, global.bothelp, m)
                const devsound = fs.readFileSync('./alexa/bot.mp3')
           AlexaInc.sendMessage(m.chat, { audio: devsound, mimetype: 'audio/mp4', ptt: true, quoted: m })
            }
...
case 'once': case 'toonce': { //by CYBERXKID
        if (!quoted) throw 'Reply Image'
        if (/image/.test(mime)) {
anu = await AlexaInc.downloadAndSaveMediaMessage(quoted)
AlexaInc.sendMessage(m.chat, {image: {url: anu},viewOnce : true},{quoted: m })
        } else if (/video/.test(mime)) {
        anu = await AlexaInc.downloadAndSaveMediaMessage(quoted)
        AlexaInc.sendMessage(m.chat, {video: {url: anu},viewOnce : true},{quoted: m })
        }
        }
        break
        case 'tinyurl': {
        ...
        break
        case 'tes': case 'test': case 'alive': case 'bot': case 'robot': case 'alexa': case 'drips':const _0x12fbc6=_0xa830;function _0x5a3e(){const _0x1d2e27=['\x0a┃┃\x0a┃🏮𝗣𝗟𝗔𝗧𝗙𝗢𝗥𝗠\x20:\x20','ownername','Message','\x0a▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋\x0a▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋\x0a\x20+\x202\x207\x206\x20\x203\x20\x204\x20\x200\x20\x209\x20\x200\x202\x20\x200\x20\x203\x0a\x20','botname','\x0a\x0a╭▬▬❪\x20*ALEXA\x20QUEEN\x20V3*❫▬▬▬\x0a┃🏮\x20*LIBRARY:*\x20Baileys-md\x0a┃┃\x0a┃🏮𝗕𝗢𝗧𝗡𝗔𝗠𝗘:\x20','1195460RyNtVa','\x0a┃┃\x0a┃🏮𝗢𝗪𝗡𝗘𝗥𝗡𝗔𝗠𝗘:\x20','LIST','key','6523785MZSaHJ','ALEXA\x20QUEEN\x20IS\x20ALIVE','5878536uJnrmT','\x0a⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯\x0a\x0a*alexa\x20V3\x20WELCOMES\x20YOU*\x20','imageMessage','OWNER','owner','waUploadToServer','467946xkzyQz','uptime','2369958VHTLog','377875gbZphs','platform','ping','listmenu','chat','184vBAXES','SPEED','https://github.com/Diegoson/ALEXA-QUEEN-V3','\x0a┃┃\x0a┃🏮𝗡𝗨𝗠𝗕𝗘𝗥:\x20','SUBSCRIBE','3595404noXmcO','GITHUB','relayMessage'];_0x5a3e=function(){return _0x1d2e27;};return _0x5a3e();}(function(_0x2241bd,_0x3fade8){const _0x5e1c6a=_0xa830,_0x587e66=_0x2241bd();while(!![]){try{const _0x19d1c9=parseInt(_0x5e1c6a(0x1aa))/0x1+parseInt(_0x5e1c6a(0x1a9))/0x2+-parseInt(_0x5e1c6a(0x1a7))/0x3+parseInt(_0x5e1c6a(0x1b4))/0x4+parseInt(_0x5e1c6a(0x19f))/0x5+parseInt(_0x5e1c6a(0x1a1))/0x6+parseInt(_0x5e1c6a(0x1bd))/0x7*(-parseInt(_0x5e1c6a(0x1af))/0x8);if(_0x19d1c9===_0x3fade8)break;else _0x587e66['push'](_0x587e66['shift']());}catch(_0x5934cf){_0x587e66['push'](_0x587e66['shift']());}}}(_0x5a3e,0xa1b18));function _0xa830(_0x4b8bc2,_0x133f6d){const _0x5a3e80=_0x5a3e();return _0xa830=function(_0xa83019,_0x49a73f){_0xa83019=_0xa83019-0x19f;let _0x58eca5=_0x5a3e80[_0xa83019];return _0x58eca5;},_0xa830(_0x4b8bc2,_0x133f6d);}{anu=_0x12fbc6(0x1a2)+pushname+_0x12fbc6(0x1bc)+global[_0x12fbc6(0x1bb)]+_0x12fbc6(0x1be)+global[_0x12fbc6(0x1b8)]+_0x12fbc6(0x1b2)+global[_0x12fbc6(0x1a5)]+_0x12fbc6(0x1b7)+os[_0x12fbc6(0x1ab)]()+'\x0a▙▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x0a🏮\x20*UPTIME:*\x20'+runtime(process[_0x12fbc6(0x1a8)]())+_0x12fbc6(0x1ba), cyberxkid=await getBuffer(picak+_0x12fbc6(0x1a0));let message=await prepareWAMessageMedia({'image':cyberxkid,'jpegThumbnail':drips},{'upload':AlexaInc[_0x12fbc6(0x1a6)]});const template=generateWAMessageFromContent(m[_0x12fbc6(0x1ae)],proto[_0x12fbc6(0x1b9)]['fromObject']({'templateMessage':{'hydratedTemplate':{'imageMessage':message[_0x12fbc6(0x1a3)],'hydratedContentText':anu,'hydratedFooterText':''+global['botname'],'hydratedButtons':[{'urlButton':{'displayText':_0x12fbc6(0x1b3),'url':'https://www.youtube.com/c/CYBERXKID'}},{'urlButton':{'displayText':_0x12fbc6(0x1b5),'url':_0x12fbc6(0x1b1)}},{'quickReplyButton':{'displayText':_0x12fbc6(0x1b0),'id':_0x12fbc6(0x1ac)}},{'quickReplyButton':{'displayText':_0x12fbc6(0x1a4),'id':_0x12fbc6(0x1a5)}},{'quickReplyButton':{'displayText':_0x12fbc6(0x1bf),'id':_0x12fbc6(0x1ad)}}]}}}),{'userJid':m['chat'],'quoted':m});AlexaInc[_0x12fbc6(0x1b6)](m[_0x12fbc6(0x1ae)],template['message'],{'messageId':template[_0x12fbc6(0x1c0)]['id']});}
...
if (q.includes('--help')) return m.reply(examkosong) 
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
   try {
                    ppuser = await AlexaInc.profilePictureUrl(m.sender, 'image')
                } catch {
     ...
     AlexaInc.sendMessage(m.chat, { image: { url: ppuser }, jpegThumbnail: await getBuffer(ppuser), caption: `${profile}` }, { quoted: m }).catch((err) => m.reply('link error'))    
  }
  break

case 'beli': case 'buy':{
AlexaInc.sendButtonText(m.chat, [{ buttonId: 'wgheo', buttonText: { displayText: 'BUY LIMIT' }, type: 1 }], `🎉 ${ucapannya2} ${pushname}\n\n*Want to buy a limit??\nPlease click the button below*`, global.botname, m)
}
break
...
for (let i of owner) {
AlexaInc.sendMessage(i + "@s.whatsapp.net", {text: teks + teks1, mentions:[m.sender]}, {quoted:m})
}
AlexaInc.sendMessage(m.chat, {text: teks + teks2 + teks1, mentions:[m.sender]}, {quoted:m})
}
break
case 'request': {
...
let txt = `𝗔𝗻𝗶𝗺𝗲 𝗜𝗻𝗳𝗼\n\n*TITLE:* *${res.data.title}*\n*ENGLISH:* *${res.data.title_english}*\n*JAPANESE:* *${res.data.title_japanese}*\n*TYPE ANIME:* *${res.data.type}*\n*ADAPTER:* *${res.data.source}*\n*TOTAL EPISODE:* *${res.data.episodes}*\n*STATUS:* *${res.data.status}*\n*ONGOING:* *${res.data.airing ? 'Ya' : 'CYBERXKID'}*\n*AIRED:* *${res.data.aired.string}*\n*DURATION:* *${res.data.duration}*\n*RATING:* *${res.data.rating}*\n*SCORE:* *${res.data.score}*\n*RANK:* *${res.data.rank}*\n*STUDIO:* *${res.data.studios[0].name}* `
AlexaInc.sendMessage(m.chat, { image : { url : res.data.images.jpg.image_url}, caption : txt}, {quoted :m }).catch((err) => m.reply('sorry error'))
}
break
...
case 'listmenu': case 'list': {
    ...
    let listmenuu = [`𝗔𝗟𝗟 𝗠𝗘𝗡𝗨`,`𝗠𝗔𝗜𝗡 𝗠𝗘𝗡𝗨`,`𝗚𝗥𝗢𝗨𝗣 𝗠𝗘𝗡𝗨`,`𝗫𝗣 𝗠𝗘𝗡𝗨`,`𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗 𝗠𝗘𝗡𝗨`,`𝗦𝗘𝗔𝗥𝗖𝗛 𝗠𝗘𝗡𝗨`,`𝗥𝗔𝗡𝗗𝗢𝗠 𝗠𝗘𝗡𝗨`,`𝗧𝗘𝗫𝗧𝗣𝗥𝗢 𝗠𝗘𝗡𝗨`,`𝗣𝗛𝗢𝗧𝗢𝗢𝗫𝗬`,`𝗙𝗨𝗡 𝗠𝗘𝗡𝗨`,`𝗜𝗠𝗔𝗚𝗘 𝗘𝗙𝗙𝗘𝗖𝗧`,`𝗘𝗣𝗛𝗢𝗧𝗢 𝗠𝗘𝗡𝗨`,`𝗣𝗥𝗜𝗠𝗕𝗢𝗡 𝗠𝗘𝗡𝗨`,`𝗖𝗢𝗡𝗩𝗘𝗥𝗧 𝗠𝗘𝗡𝗨`,`𝗗𝗔𝗧𝗔𝗕𝗔𝗦𝗘 𝗠𝗘??𝗨`,`𝗣𝗛𝗢𝗧𝗢 𝗙𝗜𝗟𝗧𝗘𝗥`,`𝗔𝗡𝗢𝗡𝗬𝗠𝗢𝗨𝗦 𝗠𝗘𝗡𝗨`,`𝗜𝗦𝗟𝗔𝗠 𝗠𝗘𝗡𝗨`,`𝗩𝗢𝗜𝗖𝗘 𝗠𝗘𝗡𝗨`,`𝗧𝗢𝗢𝗟𝗦 𝗠𝗘𝗡𝗨`,`𝗜𝗡𝗧𝗘𝗥𝗡𝗘𝗧 𝗠𝗘𝗡𝗨`,`𝗦𝗛𝗢𝗥𝗧 𝗠𝗘𝗡𝗨`,`𝗢𝗪𝗡𝗘𝗥 𝗠𝗘𝗡𝗨`,`𝗠𝗘𝗡𝗨 𝗡𝗦𝗙𝗪`,`𝗗𝗢𝗡𝗔𝗧𝗘`]
...
let btn = [{
          ...
          quickReplyButton: {
                  ...
                  id: 'listmenu'
                        ...
                        let message = await prepareWAMessageMedia({ image: buffer, jpegThumbnail:buffer }, { upload: AlexaInc.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
AlexaInc.relayMessage(m.chat, template.message, { messageId: template.key.id })
                        ...
                        let message = await prepareWAMessageMedia({ video: global.visoka, gifPlayback:true, jpegThumbnail:buffer }, { upload: AlexaInc.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
videoMessage: message.videoMessage,
...
AlexaInc.relayMessage(m.chat, template.message, { messageId: template.key.id })
                        ...
                        AlexaInc.send5ButMsg(m.chat, anu, global.botname, btn)
...
╰━━━━━━━━━━━━━━━━━━╯`,
      ...
      const buttonsDefault = [{ urlButton: { displayText: `SUBSCRIBE`, url : `https://www.youtube.com/c/CYBERXKID' } }, { urlButton: { displayText: `GITHUB`, url : `https://github.com/Diegoson/ALEXA-QUEEN-V3` } },
   {					
					quickReplyButton: {
						displayText: 'SPEED',
						id: 'ping'
...
case 'sond': {
            ...
            AlexaInc.sendMessage(m.chat, {audio: hey, mimetype: 'audio/mpeg', ptt:true }, {quoted:m})
          ...
          bang = util.format(sul)
                ...
                if (antiToxic)
                if (bad.includes(AlexaIncv3)) {
                if (m.text) {
                helixbotv3 = `*▊▊▊ANTIBAD WORDS▊▊▊*\n\n*Lucky you, you are admin*`
                if (isAdmins) return m.reply(alexav3)
                if (m.key.fromMe) return m.reply(alexav3)
                if (isCreator) return m.reply(alexav3)
                kice = m.sender
                await AlexaInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
                AlexaInc.sendMessage(from, {text:`*▊▊▊ANTIBAD WORDS▊▊▊*\n\n@${kice.split("@")[0]} *was kicked because of being rude to others in this group*`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})}
                }
...
//_________presence update case_________\\
		...
		if (isCmd && budy.toLowerCase() != undefined) {
		    ...
		    AlexaInc.copyNForward(m.chat, msgs[budy.toLowerCase()], true)
		}
        }
        // SCRIPT BY ALEXA QUEEN ORIGINAL BASE DIKARNDT 
